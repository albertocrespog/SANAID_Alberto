%function [Propulsion] = get_EngineProperties_v5(h,V,rho,alpha,beta,Geo_tier,Fdes,Prop_data,AC_CONFIGURATION)
function [Propulsion] = get_EngineProperties_v5(V,rho,phi,Fdes,Prop_data,Coeff,n_eng)
