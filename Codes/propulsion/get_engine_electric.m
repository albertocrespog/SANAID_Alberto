function Propulsion = get_engine_electric(h,V,rho,alpha,beta,Geo_tier,Fdes,Prop_data,AC_CONFIGURATION,OUTPUT_read_XLSX) % 1: TIPO DE MOTOR -->  3_PISTON
...
T_eng = Fdes/n_eng;
n = Selection_J_CT_F_des_v1(V,Prop_data,T_eng,rho,OUTPUT_read_XLSX);
RPM = n*60;
