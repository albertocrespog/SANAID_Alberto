function [fuel_total,tiempo_total,S_total,datos] = analisis_aterrizaje(aterrizaje,propul,aerodinamica,aero_aterrizaje,W_inicial,i,datos)
...
datos(i).aterrizaje.acercamiento.tiempo = tiempo_acer;
datos(i).aterrizaje.acercamiento.distancia = S_acer;
datos(i).aterrizaje.acercamiento.fuel = fuel_acer;
datos(i).aterrizaje.acercamiento.L_D = L_D_acer;
datos(i).aterrizaje.acercamiento.altura = h_obst;
datos(i).aterrizaje.acercamiento.gamma = gamma_acer;
datos(i).aterrizaje.acercamiento.velocidad = V_acer;

datos(i).aterrizaje.flare.tiempo = tiempo_flare;
datos(i).aterrizaje.flare.distancia = S_flare;
datos(i).aterrizaje.flare.fuel = fuel_flare;
datos(i).aterrizaje.flare.L_D = L_D_flare;
datos(i).aterrizaje.flare.velocidad = V_flare;
datos(i).aterrizaje.flare.altura = h_tr;
datos(i).aterrizaje.flare.gamma = gamma_flare;
datos(i).aterrizaje.flare.radio = R_flare;

datos(i).aterrizaje.free.tiempo = tiempo_free;
datos(i).aterrizaje.free.distancia = S_free;
datos(i).aterrizaje.free.fuel = fuel_free;
datos(i).aterrizaje.free.velocidad = V_TD;

datos(i).aterrizaje.ground.tiempo = tiempo_ground;
datos(i).aterrizaje.ground.distancia = S_ground;
datos(i).aterrizaje.ground.fuel = fuel_ground;

datos(i).aterrizaje.total.tiempo = tiempo_total;
datos(i).aterrizaje.total.distancia = S_total;
datos(i).aterrizaje.total.fuel = fuel_total;
