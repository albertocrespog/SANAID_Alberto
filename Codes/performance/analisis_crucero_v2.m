function [fuel_crucero,tiempo_crucero,distancia_crucero,datos] = analisis_crucero_v2(propul,aerodinamica,crucero,W_inicial,h_inicial,opcion,i,datos,Geo_tier,Prop_data,AC_CONFIGURATION)
    ...
    case 1  %CRUCERO A MACH CONSTANTE Y DISTANCIA DADA
        ...
        switch tipo_motor
            ...
            case 4
                ...
                beta = 0;
                C = 0;
                [Propulsion] = get_EngineProperties_v4(h_ini,V,rho,alpha,beta,Geo_tier,T,Prop_data,AC_CONFIGURATION);
                delta_T = Propulsion.delta_T;
        end
        ...
        if tipo_motor == 1 || tipo_motor == 2 || tipo_motor == 3
        ...
        try
            ...
            switch tipo_motor
                ...
                case 4
                    Propulsion = get_EngineProperties_dT(h,V,rho,alpha,beta,Geo_tier,delta_T,Prop_data,AC_CONFIGURATION);
                    T = Propulsion.Propulsion;
            end
