function [Weights_AP,fuel_total,tiempo_total,distancia_total,W,datos] = procesar_mision_v2(seg,tramos,output_caracteristics,Segments,FlightMODE,Geo_tier)
...
%         progressbar([],0)
        ...
        if strcmp(seg(i).nombre,'Cruise') == 1,
            ...
            [fuel(i),tiempo(i),distancia(i),datos] = analisis_crucero(propul,aerodinamica,crucero,W(i),h_inicial,cruise_mode,i,datos,Geo_tier);
        end
