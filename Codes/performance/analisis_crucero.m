function [fuel_crucero,tiempo_crucero,distancia_crucero,datos] = analisis_crucero(propul,aerodinamica,crucero,W_inicial,h_inicial,opcion,i,datos,Geo_tier,Prop_data,AC_CONFIGURATION)
