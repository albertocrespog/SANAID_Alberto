function [conditions OUTPUT_read_XLSX] = mission_changes_FR_PERFORMANCE_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
switch mission_actual
    case 1
        ...
        %% Plots prefix
        prefix = 'CASEID_01_AC_27_FR_PERFORMANCE_';
    ...
    case 2
        ...
        % Plots prefix
        prefix = 'CASEID_02_AC_27_FR_PERFORMANCE_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 3 % ID_01
        ...
        % Plots prefix
        prefix = 'CASEID_03_AC_27_FR_PERFORMANCE_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 4 % ID_01
        ...
        % Plots prefix
        prefix = 'CASEID_04_AC_27_FR_PERFORMANCE_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
