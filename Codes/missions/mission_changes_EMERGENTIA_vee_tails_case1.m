function [conditions OUTPUT_read_XLSX] = mission_changes_EMERGENTIA_vee_tails_case1(OUTPUT_read_XLSX,mission_actual,conv_UNITS)
...
switch mission_actual
    ...
    case 2 % ID_02
        ...
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.00;
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_0XCG = 0.1;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w2_CAD = Geometry_changes.Sheet_case{1}(2); %y0
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD = Geometry_changes.Sheet_case{2}(2); %y1
        OUTPUT_read_XLSX.InputGeometry_Data_flags.Lambda_LE_w2_e     = Geometry_changes.Sheet_case{3}(2)*pi/180; %Lambda
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e      = Geometry_changes.Sheet_case{4}(2)*pi/180; %Gamma
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cR_w2              = Geometry_changes.Sheet_case{5}(2); %cr
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cT_w2              = Geometry_changes.Sheet_case{6}(2); %cr
    
        % Aerodynamics
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 2; %
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 1; %
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w1 = 8;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 23; %diedro 40º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 36;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
        % Plots prefix
    ...
    case 3 % ID_03
        % Geometry
%                 OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.0390;
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_0XCG = 0.1;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w2_CAD = Geometry_changes.Sheet_case{1}(3); %y0
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD = Geometry_changes.Sheet_case{2}(3); %y1
        OUTPUT_read_XLSX.InputGeometry_Data_flags.Lambda_LE_w2_e     = Geometry_changes.Sheet_case{3}(3)*pi/180; %Lambda
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e      = Geometry_changes.Sheet_case{4}(3)*pi/180; %Gamma
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cR_w2              = Geometry_changes.Sheet_case{5}(3); %cr
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cT_w2              = Geometry_changes.Sheet_case{6}(3); %cr
...
%         Aerodynamics
    ...
    case 4 % ID_04
        ...
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.00;
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_0XCG = 0.1;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w2_CAD = Geometry_changes.Sheet_case{1}(4); %y0
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD = Geometry_changes.Sheet_case{2}(4); %y1
        OUTPUT_read_XLSX.InputGeometry_Data_flags.Lambda_LE_w2_e     = Geometry_changes.Sheet_case{3}(4)*pi/180; %Lambda
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e      = Geometry_changes.Sheet_case{4}(4)*pi/180; %Gamma
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cR_w2              = Geometry_changes.Sheet_case{5}(4); %cr
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cT_w2              = Geometry_changes.Sheet_case{6}(4); %cr
        
        % Aerodynamics
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 2; %
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 1; %
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w1 = 8;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 27; %diedro 50º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 40;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
        % Plots prefix
    ...
    case 5 % ID_05
        ...
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.00;
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_0XCG = 0.1;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w2_CAD = Geometry_changes.Sheet_case{1}(5); %y0
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD = Geometry_changes.Sheet_case{2}(5); %y1
        OUTPUT_read_XLSX.InputGeometry_Data_flags.Lambda_LE_w2_e     = Geometry_changes.Sheet_case{3}(5)*pi/180; %Lambda
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e      = Geometry_changes.Sheet_case{4}(5)*pi/180; %Gamma
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cR_w2              = Geometry_changes.Sheet_case{5}(5); %cr
        OUTPUT_read_XLSX.InputGeometry_Data_flags.cT_w2              = Geometry_changes.Sheet_case{6}(5); %cr
        
        % Aerodynamics
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 2; %
                OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 1; %
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w1 = 8;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 30; %diedro 55º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 43;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
        % Plots prefix
