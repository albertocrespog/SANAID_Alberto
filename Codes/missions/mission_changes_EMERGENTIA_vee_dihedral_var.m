function [conditions OUTPUT_read_XLSX] = mission_changes_EMERGENTIA_vee_dihedral_var(OUTPUT_read_XLSX,mission_actual,conv_UNITS)
...
switch mission_actual
    ...
    case 1 % ID_01
        % Geometry
        OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.00; %1.029384965115954
        ...
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e = 30/180*pi; %1.0716
%         OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD =0.79;

        % Aerodynamics
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 1; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 0; %
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w1 = 8;
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 4; %diedro nominal 30º
        %         OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 7;
    ...
    case 2 % ID_02
        % Geometry
        OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.0; %1.0716
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_XCG = -0.1; %1.0716
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.x_loc_1R_y1_w1_CAD = 0.871453 + 0.005; %
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e = 35/180*pi; %1.0716
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD =0.631;
        
        % Aerodynamics
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 1; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 0; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 8; %diedro 35º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 13;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V =27;
        % Plots prefix
    ...
    case 3 % ID_03
        % Geometry
        OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.0;
        %         OUTPUT_read_XLSX.InputGeometry_Data_flags.x_loc_1R_y1_w1_CAD = 0.871453 + 0.01; %
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e = 40/180*pi;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD =0.598;
        % Aerodynamics
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 1; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 0; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 9; %diedro 40º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 14;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;        
        % Plots prefix
...
%                 OUTPUT_read_XLSX.InputGeometry_Data_flags.x_loc_1R_y1_w1_CAD = 0.871453 - 0.04; %
    ...
    case 5 % ID_05
        ...
        OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG =1.0; %1.0716
        %                 OUTPUT_read_XLSX.InputGeometry_Data_flags.x_loc_1R_y1_w1_CAD = 0.871453 - 0.04; %
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e = 50/180*pi;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD =0.521;
        % Aerodynamics
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 1; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 0; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 11; %diedro 50º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 16;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
        % Plots prefix
    ...
    case 6 % ID_06
        ...
        OUTPUT_read_XLSX.InputGeometry_Data_flags.dihedral_w2_e = 55/180*pi;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y2_w2_CAD =0.478;
        % Aerodynamics
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = 1; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = 0; %
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_w2 = 12; %diedro 55º
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_vee_cy = 17;
        % Performance
        OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
        OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
        % Plots prefix
...
%         OUTPUT_read_XLSX.InputGeometry_Data_flags.z_XCG = 0.0; %1.0716
...
% %% MODIFICACIÓN TEMPORAL para barridos de incidencias: BORRAR
% var_i_w1_emerg = [0:3];
% var_i_vee_emerg = [0:3];
% 
...
% cont = 0;
% 
% for ii = 1:length(var_i_w1_emerg)
%     for kk = 1:length(var_i_vee_emerg)
%         cont = cont + 1;
%         switch mission_actual
%             case cont % ID_01
%                 % Geometry
%                 OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 1.08; %1.0716
%                 %          OUTPUT_read_XLSX.InputGeometry_Data_flags.x_loc_1R_y1_w1_CAD = 0.871453; %
%                 % Aerodynamics
%                 OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w1 = var_i_w1_emerg(ii); %
%                 OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_w2 = var_i_vee_emerg(kk); %
%                 % Performance
%                 OUTPUT_read_XLSX.IPP_flags.V_cr = OUTPUT_read_XLSX.IPP_flags.V_cr;
%                 OUTPUT_read_XLSX.Performance_pre_flags.V = 27;
%                 % Plots prefix
%                 prefix = ['CASO_ID_',num2str(cont),'_EMERGENTIA_'];
%                 OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
