function [conditions OUTPUT_read_XLSX] = mission_changes_KingAir350_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
switch mission_actual
    case 1 % ID_01
        ...
        OUTPUT_read_XLSX.PLOT_flags.fname = 'results\Cessna208';
