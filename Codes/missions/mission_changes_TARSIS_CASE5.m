...
switch mission_actual
    ...
    case 1 % ID_05. c_a, b+50 - 4 misiles
        % Mass and Inertia: Assumed to be those of T120 with missiles
        % Geometry
        % Weight Configuration from AERTEC
        conditions.n_MSL = 4; %0,1,2,3,4
    ...
    case 2 % ID_05. c_a, b+50  - 3 misiles
        % Mass and Inertia: Assumed to be those of T120 with missiles
        % Geometry
        % Weight Configuration from AERTEC
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_TARSIS_3misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 3 % ID_05. c_a, b+50 - 2 misiles
        % Mass and Inertia: Assumed to be those of T120 with missiles
        % Geometry
        % Weight Configuration from AERTEC
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_TARSIS_2misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 4 % ID_05. c_a, b+50 - 1 misiles
        % Mass and Inertia: Assumed to be those of T120 with missiles
        % Geometry
        % Weight Configuration from AERTEC
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_TARSIS_1misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 5 % ID_05. c_a, b+50 - 0 misiles
        ...
        % Plots prefix
        prefix = 'CASO_ID_05.5_TARSIS_0misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 6 % ID_05. c_a, b+50 - 4 misiles
        ...
        % Plots prefix
        prefix = 'CASO_ID_05.6_TARSIS_1misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 7 % ID_05. c_a, b+50 - 0 misiles
        %% Modification that include interference with RACK
        ...
        % Plots prefix
        prefix = 'CASO_ID_05.7_TARSIS_2misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 8 % ID_05. c_a, b+50 - 0 misiles
        %% Modification that include interference with RACK
        Racks_wing_span = 0.00;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD = OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD + Racks_wing_span;
        y_offset_w1 = OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05.8_TARSIS_3misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 9 % ID_05. c_a, b+50 - 0 misiles
        %% Modification that include interference with RACK
        Racks_wing_span = 0.00;
        OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD = OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD + Racks_wing_span;
        y_offset_w1 = OUTPUT_read_XLSX.InputGeometry_Data_flags.y_loc_1R_y1_w1_CAD;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05.9_TARSIS_4misiles_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
