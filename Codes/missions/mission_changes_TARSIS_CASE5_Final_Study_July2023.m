function [conditions OUTPUT_read_XLSX] = mission_changes_TARSIS_CASE5_Final_Study_July2023(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase1_';
        ...
        case 2 % ID_05. c_a, b+50 - Case 3 Final
        % CASE 3
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase2_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 3 % ID_05. c_a, b+50 - Case 2 Final
        % CASE 2
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase3_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 4 % ID_05. c_a, b+50 - Case 3 Final
        % CASE 3
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase4_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 5 % ID_05. c_a, b+50 - Case 4 Final
        % CASE 4
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase5_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 6 % ID_05. c_a, b+50 - Case 5 Final
        % CASE 5
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase6_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 7 % ID_05. c_a, b+50 - Case 6 Final
        % CASE 6
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase7_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 8 % ID_05. c_a, b+50 - Case 7 Final
        % CASE 7
        %% Modification that include interference with RACK
        % Used to elimnate a portion of the wing assuming that does not generate
        % lift to take into account the loss of effective area due to the racks
...
%         OUTPUT_read_XLSX.Weights_flags.CATIAT120 = CATIAT120;
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_subcase8_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
