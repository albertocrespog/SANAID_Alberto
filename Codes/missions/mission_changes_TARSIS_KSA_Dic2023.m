...
% Leyenda 
% conditions.T120 = 4; % Tarsis 120 with Experimental values (Nov 30th 2023)
% Caso 1 - Caso de control n o bola no BAT, W_Payload  = 3.5 kg
% Caso 2 - Caso configuración KSA SÓLO BOLA, con racks - giro normal resbalamiento, W_Payload  = 3.5 kg
% Caso 3 - Caso configuración KSA BOLA + BAT, con racks - giro normal resbalamiento, W_Payload  = 3.5 kg
% Caso 4 - Caso configuración KSA SÓLO BOLA, con racks - giro resbalamiento adverso, W_Payload  = 3.5 kg
% Caso 5 - Caso configuración KSA BOLA + BAT, con racks - giro resbalamiento adverso, W_Payload  = 3.5 kg

% Caso 6 - Caso configuración KSA SÓLO BOLA, con racks - giro normal resbalamiento, W_Payload  = 5.5 kg
% Caso 7 - Caso configuración KSA BOLA + BAT, con racks - giro normal resbalamiento, W_Payload  = 5.5 kg
% Caso 8 - Caso configuración KSA SÓLO BOLA, con racks - giro resbalamiento adverso, W_Payload  = 5.5 kg
% Caso 9 - Caso configuración KSA BOLA + BAT, con racks - giro resbalamiento adverso, W_Payload  = 5.5 kg
...
switch mission_actual
    case 1 % CASE 5
        ...
        conditions.porcentaje_actual = 1; % Porcentaje del total de fuel disponible para conditions.T120 = 4;
        ...
        % conditions.T120 = 4; % Tarsis 120 with Experimental values (Nov 30th 2023)
        conditions.T120 = 4; % Tarsis 120 with KSA
        ...
        elseif conditions.T120 == 4
           ...
           OUTPUT_read_XLSX.Weights_flags.Tabla_cg_inercias_T120 = conditions.Tabla_cg_inercias_T120;
           % Lectura datos CG depósito
           CATIAT120 = xlsread('Tabla cdg  e inercias depósito v2.xlsx', 'B3:N17');
           [percentage_FUEL OUTPUT] = CG_TARSIS120_KSA_V6B(conditions.W_PL, conditions.Tabla_cg_inercias_T120, CATIAT120, conditions.n_MSL,conditions.porcentaje_actual);
...
%         conditions.FUEL = 1;  % en tanto por 1
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_KSA_subcase8_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
...
%         conditions.FUEL = 1;  % en tanto por 1
        ...
        % Plots prefix
        prefix = 'CASO_ID_05_1_TARSIS_Final_case5_KSA_subcase9_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
