function [conditions OUTPUT_read_XLSX] = mission_changes_CESSNA208_PERFORMANCE_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
switch mission_actual
    case 1 % ID_01
        ...
        % Plots prefix
        prefix = 'CASEID_01_AC_22_CESSNA208_PERFORMANCE_';
    ...
    case 2 % ID_01
        ...
        % Plots prefix
        prefix = 'CASEID_02_AC_22_CESSNA208_PERFORMANCE_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
