function [conditions OUTPUT_read_XLSX] = mission_changes_EMERGENTIA_PERFORMANCE_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
% filename = '../Results/01_EMERGENTIA/Figs';
...
switch mission_actual
     ...
     case 1 % ID_01
        ...
        %% Plots prefix
        prefix = 'CASO_ID_01_01_EMERGENTIA_PERFORMANCE_';
        ...
        % Plots prefix
        prefix = 'CASO_ID_02_01_EMERGENTIA_PERFORMANCE_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
