function [conditions OUTPUT_read_XLSX] = mission_changes_ALO_Fuel_Cell_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
filename = '../Results/ALO_Fuel_Cell/Figs';
