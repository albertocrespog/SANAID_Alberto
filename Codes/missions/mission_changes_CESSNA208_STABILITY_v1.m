function [conditions OUTPUT_read_XLSX] = mission_changes_CESSNA208_STABILITY_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
switch mission_actual
    case 1 % ID_01
        ...
        % Plots prefix
        prefix = 'CASEID_01_AC_22_CESSNA208_STABILITY_';
        ...
        OUTPUT_read_XLSX.PLOT_flags.plot(18) = 1; % stops saving images for longitudinal trim since they are the same

    case 2 % ID_01
        % Geometry

        % Plots prefix
        prefix = 'CASEID_02_AC_22_CESSNA208_STABILITY_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
        ...
        conditions.conditions_TRIM_lat.Rolling_maneuver = 1;
        conditions.conditions_TRIM_lat.change_dir_roll = 1; 
        conditions.conditions_TRIM_lat.LT_engine = 2500; % Newton-m 
        ...
        %% PLOTS
        OUTPUT_read_XLSX.PLOT_flags.plot(8) = 0; % stops saving images for longitudinal trim since they are the same
        OUTPUT_read_XLSX.PLOT_flags.plot(18) = 0; % stops saving images for longitudinal trim since they are the same
    ...
    case 3
        ...
        % Plots prefix
        prefix = 'CASEID_03_AC_22_CESSNA208_STABILITY_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
        ...
        conditions.conditions_TRIM_lat.change_dir_roll = 1; 
        conditions.conditions_TRIM_lat.LT_engine = 6000; % Newton-m for engine un PT6A-42
    ...
    case 4
        ...
        % Plots prefix
        prefix = 'CASEID_04_AC_22_CESSNA208_STABILITY_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
        ...
        conditions.conditions_TRIM_lat.Rolling_maneuver = 5;
        conditions.conditions_TRIM_lat.change_dir_roll = 1; 
        conditions.conditions_TRIM_lat.LT_engine = 2500; % Newton-m for electric engine
        ...
        nhat = 0;
        conditions.conditions_TRIM_lat.nhat = nhat; % nhat = 0; 
        conditions.conditions_TRIM_lat.Fa = 89; % Fixed value
        conditions.conditions_TRIM_lat.Fr = 667; % Fixed value
    ...
    case 5
        ...
        % Plots prefix
        prefix = 'CASEID_05_AC_22_CESSNA208_STABILITY_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
    ...
    case 6
        ...
        % Plots prefix
        prefix = 'CASEID_06_AC_22_CESSNA208_STABILITY_';
        OUTPUT_read_XLSX.PLOT_flags.prefix = prefix;
        ...
        conditions.conditions_TRIM_lat.Gr = Gr*0.5; %
end
