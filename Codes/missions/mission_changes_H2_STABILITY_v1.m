function [conditions OUTPUT_read_XLSX] = mission_changes_H2_STABILITY_v1(OUTPUT_read_XLSX,mission_actual,conv_UNITS,Modifications)
...
switch mission_actual
    case 1 % ID_01
        ...
        % can 2
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_can = 3;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_can_cy = 4;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_can = 2;

        % VTP
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_can = 5;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.index_can_cy = 6;
        OUTPUT_read_XLSX.Aerodynamic_Data_flags.i_can = 0;
        
        % case 1 % Composite Build Up Method
        % case 2 % CFD or similar
        % case 3 % Approximated values from Experimental results provided by company
        ...
        %% Plots prefix
        prefix = 'CASEID_01_AC_28_H2_STABILITY_';
        ...
        %% Geometry
        OUTPUT_read_XLSX.InputGeometry_Data_flags.x_XCG = 0.473407079473691;
