...
OUTPUT_read_XLSX = read_DATA_XLSX_advanced_v2(case_AC);
...
%         OUTPUT_read_XLSX = read_DATA_XLSX_advanced(case_AC);
        ...
        save('ac_models/OUTPUT_read_XLSX_MILVUS.mat', 'OUTPUT_read_XLSX')
...
%         OUTPUT_read_XLSX = read_DATA_XLSX_advanced(case_AC);
    ...
    case 18 % case_AC = 18 - BAT
        ...
        save('ac_models/OUTPUT_read_XLSX_BAT.mat', 'OUTPUT_read_XLSX')
    case 19 % case_AC = 19 - EVOL1
        OUTPUT_read_XLSX_EVOL1 = OUTPUT_read_XLSX;
        %         save OUTPUT_read_XLSX_EVOL1.mat
        save('ac_models/OUTPUT_read_XLSX_EVOL1.mat', 'OUTPUT_read_XLSX')
    case 20 % case_AC = 20 - EVOL2
        OUTPUT_read_XLSX_EVOL2 = OUTPUT_read_XLSX;
        %         save OUTPUT_read_XLSX_EVOL2.mat
        save('ac_models/OUTPUT_read_XLSX_EVOL2.mat', 'OUTPUT_read_XLSX')
    case 21 % case_AC = 21 - EVOL3
        OUTPUT_read_XLSX_EVOL3 = OUTPUT_read_XLSX;
        %         save OUTPUT_read_XLSX_EVOL3.mat
        save('ac_models/OUTPUT_read_XLSX_EVOL3.mat', 'OUTPUT_read_XLSX')
end
