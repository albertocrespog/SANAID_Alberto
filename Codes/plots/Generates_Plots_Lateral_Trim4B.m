function [Fig] = Generates_Plots_Lateral_Trim4B(Trim_ITER_LAT4B,...
...
deltaa_deg = Trim_ITER_LAT4B.deltaa_deg;
deltar_deg = Trim_ITER_LAT4B.deltar_deg;
Fa = Trim_ITER_LAT4B.Fa; 
beta_deg = Trim_ITER_LAT4B.beta_deg;
...
deltaa_deg_var = Trim_ITER_LAT4B.deltaa_deg_var;
deltar_deg_var = Trim_ITER_LAT4B.deltar_deg_var;
Fa_var = Trim_ITER_LAT4B.Fa_var;
beta_deg_var = Trim_ITER_LAT4B.beta_deg_var;
...
deltaa_deg = Trim_ITER_LAT4B.deltaa_deg_var2;
deltar_deg = Trim_ITER_LAT4B.deltar_deg_var2;
Fa = Trim_ITER_LAT4B.Fa_var2;
beta_deg = Trim_ITER_LAT4B.beta_deg_var2;
...
if SAVE_FIGS==1
    prefix = strcat(OUTPUT_read_XLSX.PLOT_flags.prefix);
    st = strcat('deltaa_vs_V&daT_contour');
    name   = strcat(prefix,st);
    fname = OUTPUT_read_XLSX.PLOT_flags.fname;
            % Unified plot Options             
            SAVE_types(fname,name,gca,gcf); 
...
if SAVE_FIGS==1
    prefix = strcat(OUTPUT_read_XLSX.PLOT_flags.prefix);
    st = strcat('deltar_vs_V&daT_contour');
    name   = strcat(prefix,st);
    fname = OUTPUT_read_XLSX.PLOT_flags.fname;
            % Unified plot Options             
            SAVE_types(fname,name,gca,gcf); 
...
xlabel('Velocity  (m/s)','FontSize',FS)
ylabel('\delta_{aT} (deg)','FontSize',FS)
zlabel('F_{a}  (deg)','FontSize',FS)
if SAVE_FIGS==1
    prefix = strcat(OUTPUT_read_XLSX.PLOT_flags.prefix);
    st = strcat('Fa_vs_V&daT');
    name   = strcat(prefix,st);
    fname = OUTPUT_read_XLSX.PLOT_flags.fname;
            % Unified plot Options             
            SAVE_types(fname,name,gca,gcf); 
...
if SAVE_FIGS==1
    prefix = strcat(OUTPUT_read_XLSX.PLOT_flags.prefix);
    st = strcat('beta_vs_V&daT_contour');
    name   = strcat(prefix,st);
    fname = OUTPUT_read_XLSX.PLOT_flags.fname;
            % Unified plot Options             
            SAVE_types(fname,name,gca,gcf); 
