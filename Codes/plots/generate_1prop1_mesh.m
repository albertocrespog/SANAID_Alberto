function PLOTTING_UAV = generate_1prop1_mesh(OUTPUT_read_XLSX,PLOTTING_UAV,AC_CONFIGURATION,X_LOC_PROP,Prop_data)
...
Y_LOC_PROP = OUTPUT_read_XLSX.InputGeometry_Data_flags.y_eng_ybar1;
Z_LOC_PROP = 0;
% Z_LOC_PROP = OUTPUT_read_XLSX.InputGeometry_Data_flags.z_eng_ybar1;

switch Engine_conf
    case 1 % Engine_conf = 1 - pusher prop
        % Generates de disk for the Left and right Rotors
        % Reference point from the front point
        X_LOC_PROP = X_LOC_PROP;
        Y_LOC_PROP = Y_LOC_PROP;
        Z_LOC_PROP = Z_LOC_PROP;
