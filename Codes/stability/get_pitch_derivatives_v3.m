    function [Stab_Der, Stab_Der_parts] = get_pitch_derivatives_v3(AC_CONFIGURATION, Stab_Der, Stab_Der_parts,afe,conditions, Performance,Geo_tier,Body_Geo,Aero,OUTPUT_read_XLSX)
...
if Vee == 1
    ...
    if wingspan2bodydiam_vee <= 2
        CLalpha_vee_e = CL_alpha_vee*S_vee_e/Geo_tier.S_vee;
    else
...
if W1 == 1
    ...
    clalpha_w1_M0 = 1.05*cla_clatheo*clatheo; %Pamadi 3.17
    CLalpha_w1_2D = clalpha_w1_M0/sqrt(1-Mach^2); %Pamadi 3.17
    ...
    % W1 and w1 with no dynamic pressure correction %eq 4.502 PAMADI
    % Ojo revisar por la contribución de la presión dinámica
