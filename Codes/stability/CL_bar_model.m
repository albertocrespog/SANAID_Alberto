function CL_bar = CL_bar_model(x,Ctrl_Sig,EMERGENTIA,Data_ref,WT_Aero_Model,DATA_int,Data_ATM,conv_UNITS)
...
switch approx_Coeff
    case 0
        ...
        CL_bar_beta = CL_bar_f_beta(x,EMERGENTIA,Data_ref,WT_Aero_Model);
        CL_bar = CL_bar_beta + Clp*KL2*p + Clr*KL2*r + Cldeltaa*delta_a + Cldeltar*delta_r;
    case 1
        % Aerodynamic Force Coeffcients in Wind Axis
        CL_bar_beta = CL_bar_f_beta(x,EMERGENTIA,Data_ref,WT_Aero_Model);
        CL_bar = CL_bar_beta + Clp*KL2*p + Clr*KL2*r + Cldeltaa*delta_a + Cldeltar*delta_r;
    case 2
        % Aerodynamic Force Coeffcients in Wind Axis
        CL_bar_beta = CL_bar_f_beta(x,EMERGENTIA,Data_ref,WT_Aero_Model);
        CL_bar = CL_bar_beta + Clp*KL2*p + Clr*KL2*r + Clbpunto*KL2*betadot + Cldeltaa*delta_a + Cldeltar*delta_r;
end