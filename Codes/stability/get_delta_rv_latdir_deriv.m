function [Stab_Der_parts Stab_Der] = get_delta_rv_latdir_deriv(AC_CONFIGURATION,modelo,Stab_Der,Stab_Der_parts,afe,alpha,Aero,Geo_tier,OUTPUT_read_XLSX)
...
Stab_Der_parts.Cydeltarv = Cy_drv;
Stab_Der_parts.Cldeltarv = Cl_drv;
Stab_Der_parts.Cndeltarv = Cn_drv;
