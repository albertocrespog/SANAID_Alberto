function Storing_STABILITY_DATA_4D = Conduct_Stability_Study4D(conditions,conv_UNITS,Storing_STABILITY_DATA_1,OUTPUT_read_XLSX,...
    Storing_GEO_DATA,Storing_AERO_DATA,Storing_WEIGHT_DATA,case_AC,AC_CONFIGURATION,filenameS)
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1   
    ...
    Storing_STABILITY_DATA_4D = Saving_Trim_LatD(Trim_ITER_LAT4,Trim_ITER_LAT4B,Trim_ITER_LAT4C,Trim_ITER_LAT4D,conditions_TRIM_lat,OUTPUT_read_XLSX,filenameS);   
else
