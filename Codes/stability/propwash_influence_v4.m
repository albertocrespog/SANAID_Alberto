function [Stab_Der_parts, afe] = propwash_influence_v4(AC_CONFIGURATION,Geo_tier,Posicion_Palanca,conditions,Propulsion,Performance,Aero,Effects,OUTPUT_read_XLSX,Body_Geo)
