...
if model_conversion == 1
    ...
    modelo.ala.y1_b2 = y_1R_y2_ail/(Geo_tier.b_w1_e/2); %outer aleron coordinate
    modelo.ala.y0_b2 = y_1R_y1_ail/(Geo_tier.b_w1_e/2); %inner aleron coordinate
    ...
    modelo.fuselaje.D_x = Body_Geo.Area_body;
