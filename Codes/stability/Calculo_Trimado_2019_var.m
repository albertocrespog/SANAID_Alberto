function [TRIM_RESULTS,Trim_ITER] = ...
    Calculo_Trimado_2019_var(conditions,Aero,Aero_TH,Geo_tier,Weight_tier,Prop_data,conv_UNITS,...
            Body_Geo,Design_criteria,Posicion_Palanca,SM_des,XCG_FF,DATA_Ae,V_Performance,Data_ATM,x_XCG_var,XCG_data,TRIM_RESULTS,TRIM_ITER,Stab_Der)
...
TRIM_RESULTS.SM_real = SM_actual;
