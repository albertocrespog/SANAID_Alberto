function Storing_STABILITY_DATA_4A = Conduct_Stability_Study4A(conditions,conv_UNITS,Storing_STABILITY_DATA_1,OUTPUT_read_XLSX,...
    Storing_GEO_DATA,Storing_AERO_DATA,Storing_WEIGHT_DATA,case_AC)

conditions,Prop_data,Propulsion,conv_UNITS,Posicion_Palanca,...
        OUTPUT_read_XLSX_mod,AC_CONFIGURATION,only_trim,Performance_preliminar,Storing_GEO_DATA_1,Storing_WEIGHT_DATA_1,...
        Storing_AERO_DATA_1,case_AC,Plot_Options,Modifications,Storing_STABILITY_DATA_1,Storing_GEO_DATA,Storing_AERO_DATA
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1   
    Storing_STABILITY_DATA_4A = Saving_Trim_LatA(Trim_ITER_LAT,conditions_TRIM_lat,OUTPUT_read_XLSX);   
else
