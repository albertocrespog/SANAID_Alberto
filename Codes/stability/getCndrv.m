...
function Stab_Der = getCndrv(modelo,alpha,Stab_Der)
...
% The airplane yawing-moment-coefficient-due-to-ruddervator-directional-deflection derivative, also called the ruddervator directional control power, is given by:
