function [TRIM_RESULTS,Trim_ITER,Stab_Der] = resolution_trim_conditions_v2(AC_CONFIGURATION,Stab_Der,Stab_Der_parts,Design_criteria,Effects,...
...
if Vee2 == 1
    delta_rudvtr2_min = Geo_tier.delta_rudvtr2_min;
...
switch AC_type
    ...
    case 4 % AC_type = 4 - 2 surface: wing + V-tail
        CL_w1 = CL0_w1_e_corrected + CL_alpha_w1_e*i_w1 + CL_alpha_w1_e*trim_alpha;
        CL_Vee = CL0_Vee_e_corrected + CL_alpha_Vee_e*(i_vee - eps_vee) + CL_alpha_Vee_e*(downwash)*trim_alpha + CL_delta*trim_delta_e;
        CL_Total = CL_w1 + CL_Vee;
        Trim_ITER.CL_w1 = CL_w1;
        Trim_ITER.CL_Vee = CL_Vee;
        % angle of attack of HTP
        alpha_Vee = ((i_vee - eps_vee) + (downwash)*trim_alpha);
    ...
    case 8 % AC_type = 8 - 2 surface: wing + V-tail + V-tail
        CL_w1 = CL0_w1_e_corrected + CL_alpha_w1_e*i_w1 + CL_alpha_w1_e*trim_alpha;
        CL_Vee = CL0_Vee_e_corrected + CL_alpha_Vee_e*(i_vee - eps_vee) + CL_alpha_Vee2_e*(i_vee2 - eps_vee2) + CL_alpha_Vee_e*(downwash)*trim_alpha + CL_alpha_Vee2_e*(downwash)*trim_alpha + CL_delta*trim_delta_e;
        CL_Total = CL_w1 + CL_Vee;
        Trim_ITER.CL_w1 = CL_w1;
        Trim_ITER.CL_Vee = CL_Vee;
        % angle of attack of HTP
        alpha_Vee = ((i_vee - eps_vee) + (downwash)*trim_alpha);
        alpha_Vee2 = ((i_vee2 - eps_vee2) + (downwash)*trim_alpha);
        alpha_Vee_deg = alpha_Vee*R2D;
