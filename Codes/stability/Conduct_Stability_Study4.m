function Storing_STABILITY_DATA_4 = Conduct_Stability_Study4(conditions,conv_UNITS,Storing_STABILITY_DATA_1,OUTPUT_read_XLSX,...
...
% Trim lateral for asymmetric conditions
[Trim_ITER_LAT2] = Calculo_Trim_ITER_LAT_asymetry(conv_UNITS,conditions_TRIM_lat,...
    Storing_GEO_DATA,Storing_AERO_DATA,Storing_WEIGHT_DATA,Storing_STABILITY_DATA_1,conditions,case_AC,OUTPUT_read_XLSX);
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1   
    Storing_STABILITY_DATA_4 = Saving_Trim_Lat(Trim_ITER_LAT,Trim_ITER_LAT2,Trim_ITER_LAT3,conditions_TRIM_lat,OUTPUT_read_XLSX);   
else
