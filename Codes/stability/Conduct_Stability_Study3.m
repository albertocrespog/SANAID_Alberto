function Storing_STABILITY_DATA_3 = Conduct_Stability_Study3(conditions,Prop_data,conv_UNITS,...
    Posicion_Palanca,XCG_FF,OUTPUT_read_XLSX,AC_CONFIGURATION,only_trim,Performance_preliminar,case_AC,Storing_STABILITY_DATA_1,...
    Plot_Options,Storing_GEO_DATA,Storing_WEIGHT_DATA,Storing_AERO_DATA)
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1
    Storing_STABILITY_DATA_3 = Saving_data_Stability_varXCG(TRIM_RESULTS_var_XCG,Trim_ITER_var_XCG,Stab_Der_var_XCG,Stab_Der_parts_var_XCG,...
        Stab_Dyn_Long_var_XCG,Stab_Dyn_LatDir_var_XCG,case_AC,Propulsion_var_xcg,Plot_Options,OUTPUT_read_XLSX);
else
