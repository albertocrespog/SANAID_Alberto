function [Trim_ITER,Stab_Der_parts,Stab_Der] = getCM0(AC_CONFIGURATION,Geo_tier,afe,Effects,Stab_Der_parts,Body_Geo,...
...
if Vee == 1
    ...
    CM0_w2_CL0_w2 = ((x_XCG - x_xbar_w2)/cmac_w1)*(CL0_Vee_e_corrected + CL_alpha_Vee*(i_w2 - eps_w2_0));
    CM_0_w2_wrt_XCG = CM0_w2_e_corrected + CM0_w2_CL0_w2;
    Trim_ITER.CM0_w2_CL0_w2 = CM0_w2_CL0_w2;
    Trim_ITER.CM0_w2_e_corrected = CM0_w2_e_corrected;
    Trim_ITER.CM0_w2_CL0_w2 = CM0_w2_CL0_w2;
