function Storing_STABILITY_DATA_1 = Conduct_Stability_Study1(conditions,Prop_data,conv_UNITS,Posicion_Palanca,...
    XCG_FF,OUTPUT_read_XLSX,AC_CONFIGURATION,only_trim,Performance_preliminar,Storing_GEO_DATA,Storing_WEIGHT_DATA,...
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1
    Storing_STABILITY_DATA_1 = Saving_data_Stability_TRIM(TRIM_RESULTS,Trim_ITER,Stab_Der,Stab_Der_parts,Stab_Dyn_Long,Stab_Dyn_LatDir,Propulsion_values,OUTPUT_read_XLSX,Effects);
else
