function Storing_STABILITY_DATA_5 = Conduct_Stability_Study5(conv_UNITS,Storing_STABILITY_DATA_1,OUTPUT_read_XLSX,...
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1
    Storing_STABILITY_DATA_5 = Saving_Trim_Lat_Turn(Trim_ITER_LAT_Viraje,conditions_TRIM_turning,OUTPUT_read_XLSX);
