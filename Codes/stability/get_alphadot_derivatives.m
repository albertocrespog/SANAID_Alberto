function [Stab_Der,Stab_Der_parts] = get_alphadot_derivatives(AC_CONFIGURATION, Stab_Der, Stab_Der_parts,afe,conditions, Performance,Geo_tier,TRIM_RESULTS,Body_Geo,Aero,Effects,...
...
if Vee == 1
    ...
    Vbar_vee = ((x_xbar_w2 - x_XCG)/cmac_w1);%para no mult dos veces *(S_w2_e/S_ref)
    CL_alpha_wb_Vee = Aero.CL_alpha_w2_CR;
    
    if wingspan2bodydiam_w2 <= 2
        CLalpha_w2_e = CL_alpha_wb_Vee*S_w2_e/Geo_tier.S_w2;
    else
    ...
    if prop_wash_effect == 1
        ...
        CL_alphapunto_Vee_pw = CL_alphapunto_w2*conv_w2;
    end
    % Revisar OJO - contribuición de presiópn dinámica en ala w2
else
...
if Vee == 1
    ...
    if prop_wash_effect == 1
        ...
        CM_alphapunto_Vee_pw = CM_alphapunto_w2*conv_w2;
    end
else
