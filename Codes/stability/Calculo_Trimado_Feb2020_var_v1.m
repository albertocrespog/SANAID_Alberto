function [TRIM_RESULTS,Trim_ITER] = ...
    Calculo_Trimado_Feb2020_var_v1(conditions,Aero,Aero_TH,Geo_tier,Weight_tier,Prop_data,conv_UNITS,...
...
case_AC = AC_CONFIGURATION.AC_type;
...
if HTP == 1 || Vee ==1
    ...
    CL_alpha = CLalpha_wb_w1;
    X_NP = (CLalpha_wb_w1*XAC_WB)/CLalpha_wb_w1;
end
