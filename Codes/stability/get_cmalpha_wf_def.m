...
function [Trim_ITER,Stab_Der_parts,TRIM_RESULTS,Stab_Der] = get_cmalpha_wf_def(AC_CONFIGURATION,Stab_Der_parts,Body_Geo,Geo_tier,conditions,Performance,conv_UNITS,...
...
elseif AC_type == 3
    ...
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 4
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_Vee/CLalpha_wf)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 5
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_can/CLalpha_wf)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_wf)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_wf)*upwash + (CL_alpha_Vee/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 6
...
elseif AC_type == 3
    ...
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 4
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 5
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 6
...
%     xac_w = Xac_cre_W_B*cR_w1/cmac_w1;
    ...
    elseif AC_type == 3
        ...
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_Vee/CLalpha_WB)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_can/CLalpha_WB)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_WB)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_WB)*upwash + (CL_alpha_Vee/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    end
    ...
    elseif AC_type == 3
        ...
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    end
...
%     
    ...
    elseif AC_type == 3
        ...
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w  + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 6
