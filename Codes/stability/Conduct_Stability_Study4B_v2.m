function Storing_STABILITY_DATA_4B = Conduct_Stability_Study4B_v2(conditions,Prop_data,Propulsion,conv_UNITS,Posicion_Palanca,...
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1   
    Storing_STABILITY_DATA_4B = Saving_Trim_LatB(Trim_ITER_LAT2,conditions_TRIM_lat,OUTPUT_read_XLSX,filenameS);   
else
