function Storing_STABILITY_DATA_4C = Conduct_Stability_Study4C_v2(conditions,Prop_data,Propulsion,conv_UNITS,Posicion_Palanca,...
...
if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1   
    Storing_STABILITY_DATA_4C = Saving_Trim_LatC(Trim_ITER_LAT3,conditions_TRIM_lat,OUTPUT_read_XLSX);   
else
