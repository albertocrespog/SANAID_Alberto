...
function [Trim_ITER,Stab_Der_parts,TRIM_RESULTS,Stab_Der] = get_cmalpha_wf_def_v2(AC_CONFIGURATION,Stab_Der_parts,Body_Geo,Geo_tier,conditions,Performance,conv_UNITS,...
...
elseif AC_type == 2
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_HTP/CLalpha_wf)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_HTP/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 3
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_can/CLalpha_wf)*x_ac_can_bar_0*upwash + (CL_alpha_HTP/CLalpha_wf)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_wf)*upwash + (CL_alpha_HTP/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 4
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_Vee/CLalpha_wf)*x_ac_vee_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 5
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_can/CLalpha_wf)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_wf)*x_ac_vee_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_wf)*upwash + (CL_alpha_Vee/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 6
...
elseif AC_type == 7
    ...
    X_NP = X_NP_bar*cmac_w1;
elseif AC_type == 8
    X_NP_bar = (x_ac_wf_bar_0 + (CL_alpha_Vee/CLalpha_wf)*x_ac_vee_bar_0*downwash + (CL_alpha_Vee2/CLalpha_wf)*x_ac_vee2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_wf)*downwash + (CL_alpha_Vee2/CLalpha_wf)*downwash);
    X_NP = X_NP_bar*cmac_w1;
end
...
elseif AC_type == 2
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_HTP/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 3
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_HTP/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 4
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 5
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 6
...
elseif AC_type == 7
    ...
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
elseif AC_type == 8
    X_NP_no_fus_bar = (xac_w_bar_0 + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash + (CL_alpha_Vee2/CLalpha_w)*x_ac_vee2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash + (CL_alpha_Vee2/CLalpha_w)*downwash);
    X_NP_no_fus = X_NP_no_fus_bar*cmac_w1;
end
...
if wingspan2bodydiam <= 2 %%Criterio Pamadi: Pasquale Sforza, in Commercial Airplane Design Principles, 2014, p.64
    ...
    int_Sb = @(x) interp1(x_Area_body(2:end),dSdX(2:end),x).*(l_N - x);     %eq 3.36 PAMADI
...
%     xac_w = Xac_cre_W_B*cR_w1/cmac_w1;
    ...
    elseif AC_type == 2
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_HTP/CLalpha_WB)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_HTP/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 3
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_can/CLalpha_WB)*x_ac_can_bar_0*upwash + (CL_alpha_HTP/CLalpha_WB)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_WB)*upwash + (CL_alpha_HTP/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_Vee/CLalpha_WB)*x_ac_vee_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_can/CLalpha_WB)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_WB)*x_ac_vee_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_WB)*upwash + (CL_alpha_Vee/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 6
    ...
    elseif AC_type == 7
        ...
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 8
        X_NP_pam_bar = (x_ac_WB_bar_0_pam + (CL_alpha_Vee/CLalpha_WB)*x_ac_vee_bar_0*downwash + (CL_alpha_Vee2/CLalpha_WB)*x_ac_vee2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_WB)*downwash + (CL_alpha_Vee2/CLalpha_WB)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    ...
    elseif AC_type == 2
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_HTP/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    elseif AC_type == 3
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_HTP/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
     elseif AC_type == 6
     ...
     elseif AC_type == 7
        ...
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
     elseif AC_type == 8
        X_NP_nofus_pam_bar = (xac_w_bar_0_pam + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash + (CL_alpha_Vee2/CLalpha_w)*x_ac_vee2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash + (CL_alpha_Vee2/CLalpha_w)*downwash);
        X_NP_nofus_pam = X_NP_nofus_pam_bar*cmac_w1;
...
%     
    ...
    if AC_type == 1
        ...
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 2
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 + (CL_alpha_HTP/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 3
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_HTP/CLalpha_w)*x_ac_w2_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_HTP/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 4
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w  + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 5
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w + (CL_alpha_can/CLalpha_w)*x_ac_can_bar_0*upwash + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash)/(1 +(CL_alpha_can/CLalpha_w)*upwash + (CL_alpha_Vee/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
    elseif AC_type == 6
  ...
  elseif AC_type == 7
        ...
        X_NP_pam = X_NP_pam_bar*cmac_w1;
 elseif AC_type == 8
        X_NP_pam_bar = (xac_w_bar_0_pam - CMalpha_fus/CLalpha_w + (CL_alpha_Vee/CLalpha_w)*x_ac_vee_bar_0*downwash + (CL_alpha_Vee2/CLalpha_w)*x_ac_vee2_bar_0*downwash)/(1 + (CL_alpha_Vee/CLalpha_w)*downwash + (CL_alpha_Vee2/CLalpha_w)*downwash);
        X_NP_pam = X_NP_pam_bar*cmac_w1;
...
Stab_Der_parts.CM_alpha_fus = CMalpha_ac_pam;
