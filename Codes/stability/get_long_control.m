function [Stab_Der,Trim_ITER] = get_long_control(AC_CONFIGURATION,Geo_tier,Stab_Der_parts,Aero_TH,conditions,afe,Performance,Stab_Der,Trim_ITER,OUTPUT_read_XLSX)
...
if HTP == 1 
    ...
    diedro_w2 = Geo_tier.dihedral_w2;
end
...
if d_rudvtr == 1
    ...
    clalpha_w2_M0 = 1.05*cla_clatheo*clatheo; %Pamadi 3.17
    clalpha_w2 = clalpha_w2_M0/sqrt(1-Mach^2); %Pamadi 3.17
    Cla_theo_w2 = 2*pi + 5.0525*t_c_d_rudvtr;
    ...
    alpha_delta_e       = Kb_w2*Clde_Cldetheo_w2*Cldetheo_w2/clalpha_w2*alphaCL_alphaCl_w2;
    %% CL_delta_rv
    ...
    CL_delta_rv_0_naca = f_val_rv*(CL_i_vee/cos(diedro_w2))*alpha_delta_e; %Preferencia por NACA a expensas de comparar.
...
if d_ele == 1
    ...
    Cla_theo_w2 = 2*pi + 5.0525*t_c_d_ele;
    Cla_M0 = clalpha_w2_M0/Cla_theo_w2;
    ...
    % The airplane lift-coefficient-due-to-V-Tail-incidence derivative
    CL_i_w2 = CL_alpha_wb_HTP; %ya multiplicado por eta*S/S_ref en propwash_influence;
...
if d_elevon == 1
    ...
    % Save as elevons
    CL_delta_elevon = CL_delta_e;
    CD_delta_elevon = CD_delta_e;
    CM_delta_elevon = CM_delta_e;
else
    % assigns 0 if no present
    CL_delta_elevon = 0;
    CD_delta_elevon = 0;
...
if d_can == 1
    ...
    % The airplane lift-coefficient-due-to-ruddervator-deflection
    K_prima2 = 1; % APPROXIMATED > the slope at the the given ruddervator deflection.:
    CL_delta_e = CL_delta_can_0*K_prima2;
    CL_delta_can = CL_delta_e;
...
if d_flap ==1
    ...
    clalpha_w2_M0 = 1.05*cla_clatheo*clatheo;
    clalpha_w2 = clalpha_w2_M0/sqrt(1-Mach^2);
    Cla_theo_w2 = 2*pi + 5.0525*t_c_d_flap;
    Cla_M0 = clalpha_w2_M0/Cla_theo_w2;
    ...
    alpha_delta_flap       = Kb_w1*Clde_Cldetheo_w1*Cldetheo_w1/clalpha_w2*alphaCL_alphaCl_w1;
