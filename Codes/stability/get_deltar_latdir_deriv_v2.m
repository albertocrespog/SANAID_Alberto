function [Stab_Der_parts Stab_Der] = get_deltar_latdir_deriv_v2(AC_CONFIGURATION,modelo,Stab_Der,Stab_Der_parts,Geo_tier,afe,alpha,OUTPUT_read_XLSX, Aero)
...
Stab_Der_parts.Cydeltar = Cy_dr;
Stab_Der_parts.Cldeltar = Cl_dr;
Stab_Der_parts.Cndeltar = Cn_dr;
