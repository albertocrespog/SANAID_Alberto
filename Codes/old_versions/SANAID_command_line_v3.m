...
[case_AC OUTPUT_read_XLSX] = Initial_prompt;

% %% Selects Automatization process
% answer_excel =questdlg ('Would you like to Conduct Automatic Study according to Excel Selection?',...
%     'Automatic Selection',...
%     'Yes','No','Yes');
% %Handle response
% switch answer_excel
...
% % prompt = {'Enter the Aircraft Selection: (1 - EMERGENTIA 1:1, 2 - EMERGENTIA 1:2, 3 - PEPIÑOXXL, 4 - Comertial AC, 5 - WIG, 6 - CERVERA, 7 - Existing AC, 8 - Tamiz)'};
% prompt = sprintf('Enter Aicraft Selectio:\n1 - EMERGENTIA 1:1\n2 - EMERGENTIA 1:2\n3 - PEPIÑOXXL\n4 - Comertial AC\n5 - WIG\n6 - CERVERA\n7 - Existing AC,\n8 - Tamiz');
% dlgtitle = 'Aircraft Design Selection';
% dims = [1 35];
% definput = {'1'};
% opts.Interpreter = 'tex';
...
% answer_stored = questdlg('Would you like to use stored Aircraft Data', ...
...
%                 load OUTPUT_read_XLSX_EMERGENTIA.mat
...
%                 save OUTPUT_read_XLSX_EMERGENTIA.mat
%             case 2 % case_AC = 2 - EMERGENTIA 1:2
%                 OUTPUT_read_XLSX = read_DATA_XLSX(case_AC);
%                 OUTPUT_read_XLSX_EMERGENTIA = OUTPUT_read_XLSX;
%                 save OUTPUT_read_XLSX_EMERGENTIA.mat
...
[Body_Geo,meshData] = Generation_Fuselage_Data(Geo_tier,OUTPUT_read_XLSX,XFLR5_DATA,XFLR5_file,STL_file); % Defines Fuselage DATA
