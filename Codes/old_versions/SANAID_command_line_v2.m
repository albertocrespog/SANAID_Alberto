...
% Plots Stability Derivatives
STABILITY_STUDY_Stability_Derivatives_varV_m0 = 1;
% Plots Stability Study
STABILITY_STUDY_Stability_Analysis_varV_m0_long = 1; % Longitudinal Plots
STABILITY_STUDY_Stability_Analysis_varV_m0_lat = 1; % Lateral Plots
...
%         propul(9) = 28*2.54/100; % Diámetro de la hélice
    ...
    case 4 % Commercial example
        ...
        Geo_input_tier = Generation_Input_Geometric_Data_Comercial(conv_UNITS,AC_CONFIGURATION,SF);
    ...
    case 6 % case_AC = 6 CERVERA
        ...
        % AC_type = 5 - 3 surface: cannard + wing + V-tail
        AC_type = 4;
        [XCG_data AC_CONFIGURATION] = Generation_AC_configuration_CERVERA(SF,conv_UNITS,AC_type,case_AC);
        Geo_input_tier = Generation_Input_Geometric_Data_CERVERA(conv_UNITS,AC_CONFIGURATION,SF);
        % Determines the fuselage than will be shown
        % CASE_fuse = 1 - Just STL of fuselage
        % CASE_fuse = 2 - STL of the entire aircraft
        % CASE_fuse = 3 - Fuselage from XFLR5
        ...
        % ESCALADO = 2; % Scaling for emergentia, maintaing the same ratio all 3 axis
        ESCALADO = 0;
        [XFLR5_DATA,XFLR5_file,STL_file] = Generation_data_fuselage_CERVERA;
        Geo_tier = Generation_Geometric_Data_v4(Geo_input_tier,D_prop,conv_UNITS,AC_CONFIGURATION,XCG_data,case_AC);
...
Weight_tier = Generation_Weight_Data_old(Geo_tier,Body_Geo,AC_CONFIGURATION,conv_UNITS,Weight_Estimation,SF,f_f);
    ...
    if ANALYSIS_PERFORMANCE_AP_var ==1
        ...
        switch case_AC
            ...
            case 3 % case_AC = 3 - PEPIÑO XXL
                ...
                N_V_VAR_perf = 10; % number of iterations
                % Value of single speed
    ...
    if STABILITY_STUDY_Trim_var_XCG
        ...
        for i=1:N_x_XCG_VAR
          ...
          switch case_AC
              ...
              case 4
                  save Study_varXCG_COMERCIAL.mat TRIM_RESULTS_var_XCG Trim_ITER_var_XCG Stab_Der_var_XCG Stab_Der_var_XCG
              case 5
...
for i=1:length(PLOTS)
    switch PLOTS(i)
        ...
        case 5
            [MESH_DATA,Fig] = Generation_Geometry_AC(Geo_tier,Plot_Options,Body_Geo,meshData_fus,Prop_data,Fig,AC_CONFIGURATION,COLOR_scheme,case_AC,Performance,CASE_fuse,ESCALADO,SF)
%             [Fig] = plot_GEOMETRY_2018(Geo_tier,Plot_Options,Body_Geo,meshData,Prop_data,Fig,AC_CONFIGURATION,COLOR_scheme,case_AC,Performance);
        ...
        case 12
            ...
            if STABILITY_STUDY == 1
                if STABILITY_STUDY_Trim_varV_m0 == 1
                    if STABILITY_STUDY_Stability_Analysis_varV_m0_long == 1
                        [Fig] = Generates_Plots_StabilityAnalysis_long_VAR(Geo_tier,Plot_Options,Stab_Dyn_Long_var_V_XCG,Fig);
                    end
                    if STABILITY_STUDY_Stability_Analysis_varV_m0_lat == 1
