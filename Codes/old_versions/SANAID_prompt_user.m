...
answer_typeAC = Call_prompt_typeAC
...
% - 6 = Descent
% - 7 = Descent (VTOL)
answer_mission = Call_prompt_mission;
...
D_prop_in = str2num(answer_misc{1});
D_prop = D_prop_in*conv_UNITS.in2m;
% Scaling Factor
SF = str2num(answer_misc{2});
% Weight Estimation Method
Weight_Estimation = str2num(answer_misc{3});
