...
%             n_Hov(i,j) = Selection_J_CT_F_design_mass(V_Hov,Prop_data,Fdes_Hov,rho,D_prop_vect(j),solve_w_fero,n_eng);
            ...
            Propulsion_Hov{i,j} = get_Propulsive_Model_VFP(V_Hov,rho,Fdes_Hov,Prop_data,D_prop_vect(j),n_eng);
            n_Hov(i,j) = Propulsion_Hov{i,j}.RPS;
...
%             RPM_Hov(i,j) = n_Hov(i,j)*60;
            ...
            etha_mp_total_plot_design_Hov(i,j) = Propulsion_Hov{i,j}.etha_ESC;
    ...
    if plots_3D_mass_variation == 1
        % Legends
        name1   = strcat(prefix,'3D_Time_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name2   = strcat(prefix,'3D_Pe_eng_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name3   = strcat(prefix,'3D_Pe_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name4   = strcat(prefix,'3D_E_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name5   = strcat(prefix,'3D_m_prop_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name6   = strcat(prefix,'3D_m_estructure_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name7   = strcat(prefix,'3D_m_propeller_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name8   = strcat(prefix,'3D_m_energy_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name9   = strcat(prefix,'3D_delta_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
                
        figure(Fig)
        mesh(X,Y,Z_time)
        grid on
        colorbar
        Title1 = strcat('Time vs. D_{prop} & Battery Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title1)
        xlabel('D_p_r_o_p (in)')
        ...
        grid on
        colorbar
        Title2 = strcat('Electric Power per engine vs. D_{prop} & Drone Mass(', bat_prefix,')  with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title2)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        ...
        grid on
        colorbar
        Title3 = strcat('Electric Power vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title3)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        zlabel('P_e (kW)')
        ...
        grid on
        colorbar
        Title4 = strcat('Energy vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title4)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        zlabel('Energy (kW-h)')
        ...
        grid on
        colorbar
        Title5 = strcat('Propulsive System (Engine, ESC and Props) (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title5)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        ...
        grid on
        colorbar
        Title6 = strcat('Estructure (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title6)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        ...
        grid on
        colorbar
        Title7 = strcat('Propellers mass (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title7)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        ...
        grid on
        colorbar
        Title8 = strcat('Energy System Mass (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title8)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        zlabel('m_{energy} (kg)')
        ...
        figure(Fig)
        mesh(X,Y,h_delta_T_Hov)
        grid on
        colorbar
        Title9 = strcat('Throttle vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title9)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        zlabel('m_{energy} (kg)')
    ...
    if plots_contour_mass_variation == 1
        % Legends
        name1   = strcat(prefix,'Time_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name2   = strcat(prefix,'Pe_eng_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name3   = strcat(prefix,'Pe_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name4   = strcat(prefix,'E_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name5   = strcat(prefix,'m_prop_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name6   = strcat(prefix,'m_estructure_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name7   = strcat(prefix,'m_propeller_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name8   = strcat(prefix,'m_energy_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
        name9   = strcat(prefix,'delta_vs_mbat_',bat_prefix,'_n_eng_',num2str(n_eng),'_payload_',num2str(m_payload*10));
     
        figure(Fig)
        [C_time,h_time] = contour(X,Y,Z_time,vect_cc_time');
        clabel(C_time,h_time)
        grid on
        Title1 = strcat('Time (min) vs. D_{prop} & Battery Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title1)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title2b = strcat('Electric Power (kW) per engine vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title2b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        clabel(C_Pe,h_Pe)
        grid on
        Title3b = strcat('Total Electric Power (kW) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title3b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title4b = strcat('Energy (kW-h) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title4b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title5b = strcat('Propulsive System (Engine, ESC and Props) (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title5b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title6b = strcat('Estructure (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title6b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title7b = strcat('Propellers mass (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title7b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title8b = strcat('Energy System Mass (kg) vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title8b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
        ...
        grid on
        Title9b = strcat('Throttle vs. D_{prop} & Drone Mass (', bat_prefix,') with n_{eng}=',num2str(n_eng),'m_{payload}=',num2str(m_payload),' kg');
        title(Title9b)
        xlabel('D_p_r_o_p (in)')
        ylabel('Drone mass (kg)')
        if SAVE_FIGS==1
