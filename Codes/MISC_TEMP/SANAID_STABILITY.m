...
if MISSIONS_STUDY == 1
    ...
    for n=1:N_missions
        ...
        % [Plot_Options,Storing_GEO_DATA_1{n},Storing_WEIGHT_DATA_1{n},Storing_AERO_DATA_1{n},Storing_PERFORMANCE_DATA_1{n},Storing_PERFORMANCE_DATA_2{n},Storing_STABILITY_DATA_1{n},...
        %     Storing_STABILITY_DATA_2{n},Storing_STABILITY_DATA_2B{n},Storing_STABILITY_DATA_3{n},Storing_STABILITY_DATA_4A{n},Storing_STABILITY_DATA_4B{n},...
        %     Storing_STABILITY_DATA_4C{n},Storing_STABILITY_DATA_4D{n}, Storing_STABILITY_DATA_5{n},...
    ...
    for n=1:N_missions
        ...
        if OUTPUT_read_XLSX.MATLAB_flags.write_data == 1
            % Write_DATA_complete(Storing_GEO_DATA_1{n},Storing_WEIGHT_DATA_1{n},Storing_AERO_DATA_1{n},Storing_PERFORMANCE_DATA_1{n},Storing_PERFORMANCE_DATA_2{n},...
            %     Storing_STABILITY_DATA_1{n},Storing_STABILITY_DATA_2{n},Storing_STABILITY_DATA_2B{n},Storing_STABILITY_DATA_3{n},Storing_STABILITY_DATA_4A{n},...
            %     Storing_STABILITY_DATA_4B{n},Storing_STABILITY_DATA_4C{n},Storing_STABILITY_DATA_4D{n},...
    ...
    % For multiple iterations of savings
    ...
    % [Plot_Options,Storing_GEO_DATA_1,Storing_WEIGHT_DATA_1,Storing_AERO_DATA_1,Storing_PERFORMANCE_DATA_1,Storing_PERFORMANCE_DATA_2,Storing_STABILITY_DATA_1,...
    %     Storing_STABILITY_DATA_2,Storing_STABILITY_DATA_2B,Storing_STABILITY_DATA_3,Storing_STABILITY_DATA_4A,Storing_STABILITY_DATA_4B,Storing_STABILITY_DATA_4C,...
    %     Storing_STABILITY_DATA_5,Storing_PROPULSION_DATA,OUTPUT_read_XLSX] = conduct_Analysis(conv_UNITS,AC_CONFIGURATION,OUTPUT_read_XLSX,case_AC,Fig,Plot_Options,...
    ...
    %     Storing_STABILITY_DATA_4C,Storing_STABILITY_DATA_5,...
    %     Storing_PERFORMANCE_DATA_1,Storing_PERFORMANCE_DATA_2,Storing_PROPULSION_DATA,conv_UNITS,AC_CONFIGURATION,case_AC);
    ...
    if OUTPUT_read_XLSX.MATLAB_flags.write_data == 1
        %     Write_DATA_complete(Storing_GEO_DATA_1,Storing_WEIGHT_DATA_1,Storing_AERO_DATA_1,Storing_PERFORMANCE_DATA_1,Storing_PERFORMANCE_DATA_2,Storing_STABILITY_DATA_1,...
        %         Storing_STABILITY_DATA_2,Storing_STABILITY_DATA_2B,Storing_STABILITY_DATA_3,Storing_STABILITY_DATA_4A,Storing_STABILITY_DATA_4B,Storing_STABILITY_DATA_4C,...
        %         Storing_STABILITY_DATA_5,Storing_PROPULSION_DATA,M_alpha_cero,V_alpha_cero,conv_UNITS,mission_actual,n,case_AC,OUTPUT_read_XLSX);
    ...
    if OUTPUT_read_XLSX.MATLAB_flags.save_MAT == 1
        % Saving_DATA_complete(Plot_Options,Storing_GEO_DATA_1,Storing_WEIGHT_DATA_1,Storing_AERO_DATA_1,Storing_PERFORMANCE_DATA_1,Storing_PERFORMANCE_DATA_2,Storing_STABILITY_DATA_1,...
        ...
        %     Storing_STABILITY_DATA_4C,Storing_STABILITY_DATA_5,Storing_PROPULSION_DATA,M_alpha_cero,V_alpha_cero,case_AC);
