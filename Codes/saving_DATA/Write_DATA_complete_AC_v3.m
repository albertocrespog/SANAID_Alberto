...
function Write_DATA_complete_AC_v3(Storing_DATA,M_alpha_cero,V_alpha_cero,conv_UNITS,mission_actual,n,case_AC,OUTPUT_read_XLSX,filename,Sheet_AC,Sheet_AC2)
...
if OUTPUT_read_XLSX.STUDY_flags.STABILITY_STUDY_Trim_lat_Trim_TAB == 1
    writematrix(Misc,filename,'Sheet',Sheet_AC,'Range',name_misc)
end
