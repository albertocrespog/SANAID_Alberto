function Saving_LateralDirectional_Dynamics(Matrix_lat,Deflection_lat,m_TOW,V,OUTPUT_read_XLSX,filenameS)
...
save(name, 'Matrix_lat','Deflection_lat','m_TOW','V')