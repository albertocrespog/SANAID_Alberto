function Storing_PERFORMANCE_DATA_1 = Saving_data_Performance_Optimization1_v2(Segments,handles,Weights_AP,Total_Datos,datos,Storing_PROPULSION_DATA,seg,filenameS,OUTPUT_read_XLSX)
...
st3 = strcat(st1,st2);
st3A = strcat('\Study_PERFORMNCE_DATA1.mat');
