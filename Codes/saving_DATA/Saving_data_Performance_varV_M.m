function Storing_PERFORMANCE_DATA_2 = Saving_data_Performance_21_varV_M(Storing_PERFORMANCE_2,Plot_Options,Restrictions_var_V_m,OUTPUT_read_XLSX,Storing_PROPULSION_DATA,filenameS)
         
Storing_PERFORMANCE_DATA_2.Storing_PERFORMANCE_2 = Storing_PERFORMANCE_2;
Storing_PERFORMANCE_DATA_2.Plot_Options = Plot_Options;
Storing_PERFORMANCE_DATA_2.Restrictions_var_V_m = Restrictions_var_V_m;
...
st3 = strcat(st1,st2);
st3A = strcat('\Study_Performance_var_m_varV.mat');
...
save(name,'Storing_PERFORMANCE_2','Plot_Options','Restrictions_var_V_m','Storing_PROPULSION_DATA');