...
function Write_DATA_complete_AC(Storing_GEO_DATA_1,Storing_WEIGHT_DATA_1,Storing_AERO_DATA_1,Storing_PERFORMANCE_DATA_1,Storing_STABILITY_DATA_1,...
        ...
        Storing_PROPULSION_DATA,M_alpha_cero,V_alpha_cero,conv_UNITS,mission_actual,n,case_AC,OUTPUT_read_XLSX,filename,Sheet_AC)
...
if OUTPUT_read_XLSX.STUDY_flags.STABILITY_STUDY == 1
    switch AC_type
        ...
        case 2 % AC_type = 2 - Conventional 2 surface: wing + HTP + VTP
            ...
            CM_0_w1_wrt_XCG = Storing_STABILITY_DATA_1.Stab_Der_parts.CM_0_w1;
            CM_0_w2_wrt_XCG = Storing_STABILITY_DATA_1.Stab_Der_parts.CM_0_w2;
            CM_0_w3_wrt_XCG = 0;
        ...
        case 3 % AC_type = 3 - 3 surface: cannard + wing + HTP + VTP
            ...
            CM_0_w3_wrt_XCG = Storing_STABILITY_DATA_1.Stab_Der_parts.CM_0_w2;
        ...
        case 5 % AC_type = 5 - 3 surface: cannard + wing + V-tail
            ...
            CM_0_w1_wrt_XCG = Storing_STABILITY_DATA_1.Stab_Der_parts.CM_0_w1;
            CM_0_w2_wrt_XCG = Storing_STABILITY_DATA_1.Stab_Der_parts.CM_0_can_wrt_XCG;
...
if OUTPUT_read_XLSX.STUDY_flags.PERFORMANCE_STUDY == 1
    ...
    if handles.propul(1) == 4
        m_bat = Storing_PERFORMANCE_DATA_1{4}.Weights_AP.m_bat;
        m_f = 0;
        C_fuel = 0;
    else
        m_bat = 0;
        m_f = Storing_PERFORMANCE_DATA_1{4}.Weights_AP.m_f;
        C_fuel = Storing_PERFORMANCE_DATA_1{1}{6}.TOTAL.C_fuel;
    end
    ...
    Stab = [Total_Datos.tiempo_total/60;...
        Total_Datos.distancia_total/1000;...
        Weights_AP.m_TOW;...
        Storing_PERFORMANCE_DATA_1{1}{4}.m_e;...
        Storing_PERFORMANCE_DATA_1{1}{4}.m_p;...
        Weights_AP.m_F;...
        m_f;...
        m_bat;...
        C_fuel];
...
N_elements_geo = 29;
range_geo_i = init + 1;
range_geo_f = init + N_elements_geo;
...
% var_i_vee_emerg = [0:3];
% 
% num_cases = length(var_i_w1_emerg)*length(var_i_vee_emerg);
% prefixes = char([68:90,97:122]);
% cont = 0;
% for kk = 1:num_cases+1
% switch mission_actual
%     case cont
%         prefix = prefixes(cont);
% end
% cont = cont + 1;
% end
...
% if OUTPUT_read_XLSX.STUDY_flags.PERFORMANCE_STUDY == 1
%     writem atrix(Perfo,filename,'Sheet',Sheet_AC,'Range',name_perfo)
% end
