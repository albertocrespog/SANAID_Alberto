function Storing_STABILITY_DATA_4B = Saving_Trim_LatB(Trim_ITER_LAT2,conditions_TRIM_lat,OUTPUT_read_XLSX,filenameS)
...
st3 = strcat(st1,st2);
st3A = strcat('\Study_Trim_ITER_LAT_B.mat');
...
save(name, 'Trim_ITER_LAT2','conditions_TRIM_lat')

Storing_STABILITY_DATA_4B.Trim_ITER_LAT2 = Trim_ITER_LAT2;
Storing_STABILITY_DATA_4B.conditions_TRIM_lat = conditions_TRIM_lat;
