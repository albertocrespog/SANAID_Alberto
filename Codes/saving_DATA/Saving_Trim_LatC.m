function Storing_STABILITY_DATA_4C = Saving_Trim_LatC(Trim_ITER_LAT3,conditions_TRIM_lat,OUTPUT_read_XLSX,filenameS)
...
st3 = strcat(st1,st2);
st3A = strcat('\Study_Trim_ITER_LAT_C.mat');
...
save(name, 'Trim_ITER_LAT3','conditions_TRIM_lat')

Storing_STABILITY_DATA_4C.Trim_ITER_LAT3 = Trim_ITER_LAT3;
Storing_STABILITY_DATA_4C.conditions_TRIM_lat = conditions_TRIM_lat;
