function Geo_tier = Generation_Geometric_Data_v3(Geo_input_tier,D_prop,conv_UNITS,AC_CONFIGURATION,XCG_data,case_AC)
...
% Wingspan - VTP
b_VTP_s = (b_VTP/cos(dihedral_VTP_e)); % effective wingspan in y direction
...
S_VTP_ph = S_VTP_s*cos(dihedral_VTP_e); % Proyected area of the w1 ino the horizontal plane
S_VTP_pv = S_VTP_s*sin(dihedral_VTP_e); % Proyected area of the w1 ino the vertical plane
...
Lambda_TE_VTP = Get_Nth_Lambda(1,AR_VTP_e,Lambda_LE_w2,lambda_VTP_e);
% Storing DATA
...
x_1R_y2_VTP = x_1R_y1_VTP + (b_VTP/2 - y_offset_VTP)*tan(Lambda_LE_VTP); % defines inner position of wing chord (ruddervator section) LE
x_2R_y2_VTP = x_1R_y2_VTP + cT_VTP; % defines inner position of wing chord TE
% spanwise location
y_1R_y1_VTP = b_VTP/2 - b_VTP_e/2; % inner position from the center line
y_2R_y1_VTP = y_1R_y1_VTP; % inner position from the center line (same as LE assumes chord paralel to x-axis)
y_1R_y2_VTP = b_VTP/2; % outter position from the center line
...
z_1R_y2_VTP = z_1R_y1_VTP + (b_VTP/2 - y_offset_VTP)*tan(dihedral_VTP);
z_2R_y2_VTP = z_2R_y1_VTP + (b_VTP/2 - y_offset_VTP)*tan(dihedral_VTP);
% Storing DATA
...
y_cT_VTP_LE = y_cR_VTP_LE + b_VTP_e/2;
...
XYZ_MAC = Get_MAC_Coordinates(b_VTP,lambda_VTP,cR_VTP,dihedral_VTP,Lambda_c4_VTP);
...
% Geometric position of VTP MAC
XYZ_MAC = Get_MAC_Coordinates(b_VTP_e,lambda_VTP_e,cR_VTP,dihedral_VTP,Lambda_c4_VTP);
...
K_y1_rudder_w2 = Geo_tier.K_y1_rudder_w2;
K_y2_rudder_w2 = Geo_tier.K_y2_rudder_w2;
K_y1_rudvtr_w2 = Geo_tier.K_y1_rudvtr_w2;
K_y2_rudvtr_w2 = Geo_tier.K_y2_rudvtr_w2;
K_y1_can_w2 = Geo_tier.K_y1_can_w2;
K_y2_can_w2 = Geo_tier.K_y2_can_w2;
...
CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_ele,y_2R_y1_ele,y_1R_y2_ele,y_2R_y2_ele,...
    x_1R_y1_w2,x_2R_y1_w2,y_offset_w2,Lambda_LE_w2,Lambda_TE_w2,Lambda_c4_w2,dihedral_w2,cf_ele);
...
CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_elevon,y_2R_y1_elevon,y_1R_y2_elevon,y_2R_y2_elevon,...
    x_1R_y1_w1,x_2R_y1_w1,y_offset_w1,Lambda_LE_w1,Lambda_TE_w1,Lambda_c4_w1,dihedral_w1,cf_elevon);
...
% y1 identifies inner position
% y2 identifies outer position
y_1R_y1_rudder = y_offset_w2 + (b_VTP_e)*K_y1_rudder_w2; % inner position from the center line
y_2R_y1_rudder = y_1R_y1_rudder; % inner position from the center line
y_1R_y2_rudder = y_offset_w2 + (b_VTP_e)*K_y2_rudder_w2; % outter position from the center line
y_2R_y2_rudder = y_1R_y2_rudder; % outter position from the center line

% Calculates geometric information regarding the control surfaces
CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_rudder,y_2R_y1_rudder,y_1R_y2_rudder,y_2R_y2_rudder,...
    x_1R_y1_VTP,x_2R_y1_VTP,y_offset_w2,Lambda_LE_VTP,Lambda_TE_VTP,Lambda_c4_VTP,dihedral_VTP,cf_rudder);
...
switch Engine_loc
    ...
    case 2 % Engine_loc = 2 - fuselage - in front
        % the nacelle
        x_eng_xbar = 0;  % At the front of the fuselage
        y_eng_ybar = 0;
        z_eng_zbar = 0;
        % Storing DATA
        Geo_tier.x_eng_xbar = x_eng_xbar;
