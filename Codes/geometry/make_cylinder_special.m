function [PLOT_DISK] = make_cylinder_special(R,H,SD)
...
for i_pat=1:n_side
    % Side patches data
    PatchData1_Z(:,i_pat) = VertexData(Index_Patch1(i_pat,:),1);
    PatchData1_Y(:,i_pat) = VertexData(Index_Patch1(i_pat,:),2);
    PatchData1_X(:,i_pat) = VertexData(Index_Patch1(i_pat,:),3);
end
...
PLOT_DISK.PatchData1_X = PatchData1_X;
PLOT_DISK.PatchData1_Y = PatchData1_Y;
PLOT_DISK.PatchData1_Z = PatchData1_Z;
...
for i_pat=1:2
    % Bottom patches data
    PatchData2_Z(:,i_pat) = VertexData(Index_Patch2(i_pat,:),1);
    PatchData2_Y(:,i_pat) = VertexData(Index_Patch2(i_pat,:),2);
    PatchData2_X(:,i_pat) = VertexData(Index_Patch2(i_pat,:),3);
end
...
PLOT_DISK.PatchData2_X = PatchData2_X;
PLOT_DISK.PatchData2_Y = PatchData2_Y;
PLOT_DISK.PatchData2_Z = PatchData2_Z;