function Geo_tier = Generation_Geometric_Data_v6(Geo_input_tier,conv_UNITS,AC_CONFIGURATION,OUTPUT_read_XLSX,case_AC)
...
if W1 == 1
    ...
    % Wingspan - w1
    b_w1_s = (b_w1_e/cos(abs(dihedral_w1_e))); % effective wingspan in y direction
    b_w1_pv = b_w1_s*sin(abs(dihedral_w1_e)); % effective wingspan in vertical direction direction
    ...
    S_w1_ph = S_w1_s*cos(abs(dihedral_w1_e)); % Proyected area of the w1 ino the horizontal plane
    S_w1_pv = S_w1_s*sin(abs(dihedral_w1_e)); % Proyected area of the w1 ino the vertical plane
...
if Can == 1
    ...
    % Wingspan - can
    b_can_s = (b_can_e/cos(abs(dihedral_can_e))); % effective wingspan in y direction
    b_can_pv = b_can_s*sin(abs(dihedral_can_e)); % effective wingspan in vertical direction direction
    ...
    S_can_ph = S_can_s*cos(abs(dihedral_can_e)); % Proyected area of the can ino the horizontal plane
    S_can_pv = S_can_s*sin(abs(dihedral_can_e)); % Proyected area of the can ino the vertical plane
    ...
    if W1 == 1
        l_xac_canw1 = x_xbar_w1 - x_xbar_can; % from xac_wing1 to xac_wing2
    else
        l_xac_canw1 = 0;
    end 
    
    Geo_tier.l_xac_canw1 = l_xac_canw1;
...
if HTP == 1 
    ...
    % y1 identifies inner position
    % y2 identifies outer position
    x_loc_1R_y1_HTP_CAD = Geo_tier.x_loc_1R_y1_HTP_CAD;
    y_loc_1R_y1_HTP_CAD = Geo_tier.y_loc_1R_y1_HTP_CAD;
    z_loc_1R_y1_HTP_CAD = Geo_tier.z_loc_1R_y1_HTP_CAD;
    x_loc_1R_y2_HTP_CAD = Geo_tier.x_loc_1R_y2_HTP_CAD;
    y_loc_1R_y2_HTP_CAD = Geo_tier.y_loc_1R_y2_HTP_CAD;
    z_loc_1R_y2_HTP_CAD = Geo_tier.z_loc_1R_y2_HTP_CAD;
    if HTP == 1
        y_loc_1R_yB1_HTP_CAD = Geo_tier.y_loc_1R_yB1_HTP_CAD;
        y_loc_1R_yB2_HTP_CAD = Geo_tier.y_loc_1R_yB2_HTP_CAD;
    end
    x_y1_y2_HTP_CAD = Geo_tier.x_y1_y2_HTP_CAD;
    y_y1_y2_HTP_CAD = Geo_tier.y_y1_y2_HTP_CAD;
    z_y1_y2_HTP_CAD = Geo_tier.z_y1_y2_HTP_CAD;
    % Wingspan - HTP
    b_HTP = Geo_tier.b_HTP;
    b_HTP_e = Geo_tier.b_HTP_e;
    b_HTP_fus = Geo_tier.b_HTP_fus;
    
    % Location of LE HTP
    x_loc_LE_HTP_CAD = x_loc_1R_y1_HTP_CAD; % distance from CAD refference point
    y_loc_LE_HTP_CAD = y_loc_1R_y1_HTP_CAD; % distance from CAD refference point
    z_loc_LE_HTP_CAD = z_loc_1R_y1_HTP_CAD; % distance from CAD refference point
    x_loc_LE_HTP = x_loc_LE_HTP_CAD + x_offset_CAD;
    y_loc_LE_HTP = b_HTP_fus/2;
    z_loc_LE_HTP = z_loc_LE_HTP_CAD + z_offset_CAD;
    % Storing DATA
    Geo_tier.x_loc_LE_HTP = x_loc_LE_HTP;
    Geo_tier.y_loc_LE_HTP = y_loc_LE_HTP;
    Geo_tier.z_loc_LE_HTP = z_loc_LE_HTP;
    Geo_tier.x_loc_LE_HTP_CAD = x_loc_LE_HTP_CAD;
    Geo_tier.y_loc_LE_HTP_CAD = y_loc_LE_HTP_CAD;
    Geo_tier.z_loc_LE_HTP_CAD = z_loc_LE_HTP_CAD;
    
    % Location of LE w1 and HTP
    x_HTP_LE = x_loc_LE_HTP;
    y_HTP_LE = y_loc_LE_HTP;
    z_HTP_LE = z_loc_LE_HTP;
    % Storing DATA
    Geo_tier.x_HTP_LE = x_HTP_LE;
    Geo_tier.y_HTP_LE = y_HTP_LE;
    Geo_tier.z_HTP_LE = z_HTP_LE;
    
    % Angles
    Lambda_LE_HTP = Geo_tier.Lambda_LE_HTP;
    dihedral_HTP = Geo_tier.dihedral_HTP;
    dihedral_HTP_e = Geo_tier.dihedral_HTP_e;
    if HTP == 1
        Lambda_LE_HTP_k1_e = Geo_tier.Lambda_LE_HTP_k1_e;
        Lambda_LE_HTP_k2_e = Geo_tier.Lambda_LE_HTP_k2_e;
        dihedral_HTP_k1_e = Geo_tier.dihedral_HTP_k1_e;
        dihedral_HTP_k2_e = Geo_tier.dihedral_HTP_k2_e;
    end
    ...
    if HTP == 1
        cB_k1_HTP = Geo_tier.cB_k1_HTP;
        cB_k2_HTP = Geo_tier.cB_k2_HTP;
    end
    cT_HTP = Geo_tier.cT_HTP;
    
    % Wingspan - HTP
    b_HTP_s = (b_HTP_e/cos(abs(dihedral_HTP_e)));
    % effective wingspan in y direction
    b_HTP_pv = b_HTP_s*sin(abs(dihedral_HTP_e)); % effective wingspan in vertical direction direction
    
    % Storing Data
    Geo_tier.b_HTP_s = b_HTP_s;
    Geo_tier.b_HTP_pv = b_HTP_pv;
        
    % Wing area 2
    S_HTP_e = b_HTP_e*(cR_HTP+cT_HTP)/2; % effective wing area: proyected in teh y-plane
    S_HTP_s = b_HTP_s*(cR_HTP+cT_HTP)/2; % real wing area: proyected along the surface of wing
    S_HTP_fus = cR_HTP*b_HTP_fus; % HTP area within the fuselage
%     S_HTP = S_HTP_e; % HTP Reference area % Cola en V with no fuselage interference
    S_HTP = S_HTP_e + S_HTP_fus; % HTP Reference area
    S_HTP_ph = S_HTP_s*cos(abs(dihedral_HTP_e)); % Proyected area of the w1 ino the horizontal plane
    S_HTP_pv = S_HTP_s*sin(abs(dihedral_HTP_e)); % Proyected area of the w1 ino the vertical plane
        
    % Storing DATA
    Geo_tier.S_HTP = S_HTP;
    Geo_tier.S_HTP_e  = S_HTP_e;
    Geo_tier.S_HTP_s  = S_HTP_s;
    Geo_tier.S_HTP_fus  = S_HTP_fus;
    Geo_tier.S_HTP_ph  = S_HTP_ph;
    Geo_tier.S_HTP_pv  = S_HTP_pv;
    
    % Aspect Ratio
    AR_HTP = b_HTP^2/S_HTP;
    AR_HTP_e = b_HTP_e^2/S_HTP_e;
    AR_HTP_s = b_HTP_s^2/S_HTP_s;
    
    % Storing DATA
    Geo_tier.AR_HTP = AR_HTP;
    Geo_tier.AR_HTP_e = AR_HTP_e;
    Geo_tier.AR_HTP_s = AR_HTP_s;
    
    % Taper Ratio
    lambda_HTP = cT_HTP/cR_HTP;
    lambda_HTP_e = cT_HTP/cR_HTP;
    % Storing DATA
    Geo_tier.lambda_HTP = lambda_HTP;
    Geo_tier.lambda_HTP_e = lambda_HTP_e;
    
    %% Calculation of Sweep angles
    % Quarter Chord
    Lambda_c4_HTP = Get_Nth_Lambda(1/4,AR_HTP_e,Lambda_LE_HTP,lambda_HTP_e);
    % Half chord
    Lambda_c2_HTP = Get_Nth_Lambda(1/2,AR_HTP_e,Lambda_LE_HTP,lambda_HTP_e);
    % Trailing Edge
    Lambda_TE_HTP = Get_Nth_Lambda(1,AR_HTP_e,Lambda_LE_HTP,lambda_HTP_e);
    % 3/4 of chord
    Lambda_c34_HTP = Get_Nth_Lambda(3/4,AR_HTP_e,Lambda_LE_HTP,lambda_HTP_e);
    
    % Storing DATA
    Geo_tier.Lambda_TE_HTP  = Lambda_TE_HTP;
    Geo_tier.Lambda_TE_HTP  = Lambda_TE_HTP;
    Geo_tier.Lambda_c4_HTP  = Lambda_c4_HTP;
    Geo_tier.Lambda_c2_HTP  = Lambda_c2_HTP;
    Geo_tier.Lambda_c34_HTP  = Lambda_c34_HTP;
        
    %% Geometric location of the HTP in order to define the corners of the surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    x_1R_y1_HTP = 0; % defines inner position of wing chord (aileron section) LE
    x_2R_y1_HTP = x_1R_y1_HTP + cR_HTP; % defines inner position of wing chord TE
    % chord at each location
    y_offset_HTP = b_HTP_fus/2;
    x_1R_y2_HTP = x_1R_y1_HTP + (b_HTP/2 - y_offset_HTP)*tan(Lambda_LE_HTP); % defines inner position of wing chord (ruddervator section) LE
    x_2R_y2_HTP = x_1R_y2_HTP + cT_HTP; % defines inner position of wing chord TE
    % spanwise location
    y_1R_y1_HTP = b_HTP/2 - b_HTP_e/2; % inner position from the center line
    y_2R_y1_HTP = y_1R_y1_HTP; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    y_1R_y2_HTP = b_HTP/2; % outter position from the center line
    y_2R_y2_HTP = y_1R_y2_HTP; % outter position from the center line (same as LE assumes chord paralel to x-axis)
    % z-position
    z_1R_y1_HTP = 0; % inner position from the center line
    z_2R_y1_HTP = 0; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    z_1R_y2_HTP = z_1R_y1_HTP + (b_HTP/2 - y_offset_HTP)*tan(dihedral_HTP);
    z_2R_y2_HTP = z_2R_y1_HTP + (b_HTP/2 - y_offset_HTP)*tan(dihedral_HTP);
    
    % Storing DATA
    Geo_tier.x_1R_y1_HTP = x_1R_y1_HTP;
    Geo_tier.x_2R_y1_HTP = x_2R_y1_HTP;
    Geo_tier.x_1R_y2_HTP = x_1R_y2_HTP;
    Geo_tier.x_2R_y2_HTP = x_2R_y2_HTP;
    Geo_tier.y_1R_y1_HTP = y_1R_y1_HTP;
    Geo_tier.y_2R_y1_HTP = y_2R_y1_HTP;
    Geo_tier.y_1R_y2_HTP = y_1R_y2_HTP;
    Geo_tier.y_2R_y2_HTP = y_2R_y2_HTP;
    Geo_tier.z_1R_y1_HTP = z_1R_y1_HTP;
    Geo_tier.z_2R_y1_HTP = z_2R_y1_HTP;
    Geo_tier.z_1R_y2_HTP = z_1R_y2_HTP;
    Geo_tier.z_2R_y2_HTP = z_2R_y2_HTP;
    Geo_tier.y_offset_HTP = y_offset_HTP;
    
    % Position relative to the Origin
    % X-position
    x_cR_HTP_LE = x_HTP_LE + x_1R_y1_HTP;
    x_cR_HTP_TE = x_HTP_LE + x_2R_y1_HTP;
    x_cT_HTP_LE = x_HTP_LE + x_1R_y2_HTP;
    x_cT_HTP_TE = x_HTP_LE + x_2R_y2_HTP;
    % Y-position
    y_cR_HTP_LE = y_offset_HTP;
    y_cR_HTP_TE = y_cR_HTP_LE;
    y_cT_HTP_LE = y_cR_HTP_LE + b_HTP_e/2;
    y_cT_HTP_TE = y_cT_HTP_LE;
    % Z-position
    
    z_cR_HTP_LE = z_loc_LE_HTP + z_1R_y1_HTP; % inner position from the center line
    z_cT_HTP_LE = z_loc_LE_HTP + z_1R_y2_HTP; % inner position from the center line
    z_cR_HTP_TE = z_loc_LE_HTP + z_2R_y1_HTP;
    z_cT_HTP_TE = z_loc_LE_HTP + z_2R_y2_HTP;
    
    % Storing DATA
    Geo_tier.x_cR_HTP_LE = x_cR_HTP_LE;
    Geo_tier.x_cR_HTP_TE = x_cR_HTP_TE;
    Geo_tier.x_cT_HTP_LE = x_cT_HTP_LE;
    Geo_tier.x_cT_HTP_TE = x_cT_HTP_TE;
    Geo_tier.y_cR_HTP_LE = y_cR_HTP_LE;
    Geo_tier.y_cT_HTP_LE = y_cT_HTP_LE;
    Geo_tier.y_cR_HTP_TE = y_cR_HTP_TE;
    Geo_tier.y_cT_HTP_TE = y_cT_HTP_TE;
    Geo_tier.z_cR_HTP_LE = z_cR_HTP_LE;
    Geo_tier.z_cT_HTP_LE = z_cT_HTP_LE;
    Geo_tier.z_cR_HTP_TE = z_cR_HTP_TE;
    Geo_tier.z_cT_HTP_TE = z_cT_HTP_TE;

    % Geometric position of HTP MAC
    XYZ_MAC = Get_MAC_Coordinates(b_HTP,lambda_HTP,cR_HTP,dihedral_HTP,Lambda_c4_HTP);
    Geo_tier.cmac_HTP = XYZ_MAC.cbar;
    Geo_tier.xbar_HTP = XYZ_MAC.xbar_w;
    Geo_tier.ybar_HTP = XYZ_MAC.ybar_w;
    Geo_tier.zbar_HTP = XYZ_MAC.zbar_w;
    
    % Geometric position of HTP MAC
    XYZ_MAC = Get_MAC_Coordinates(b_HTP_e,lambda_HTP_e,cR_HTP,dihedral_HTP,Lambda_c4_HTP);
    Geo_tier.cmac_HTP_e = XYZ_MAC.cbar;
    Geo_tier.xbar_HTP_e = XYZ_MAC.xbar_w;
    Geo_tier.ybar_HTP_e = XYZ_MAC.ybar_w;
    Geo_tier.zbar_HTP_e = XYZ_MAC.zbar_w;
    
    if HTP == 1
        [S_e_HTP, S_HTP, S_s_HTP, S_fus_HTP, S_ph_HTP, S_pv_HTP, AR_HTP, AR_e_HTP, AR_s_HTP, XYZ_MAC_HTP, ...
            XYZ_MAC_e_HTP] = get_crankedwing_geom_airbus_method(cR_HTP, cB_k1_HTP, cB_k2_HTP, cT_HTP,...
            y_loc_LE_HTP_CAD, y_loc_1R_yB1_HTP_CAD, y_loc_1R_yB2_HTP_CAD, y_loc_1R_y2_HTP_CAD, ...
            Lambda_LE_HTP, Lambda_LE_HTP_k1_e , Lambda_LE_HTP_k2_e, dihedral_HTP, dihedral_HTP_k1_e, dihedral_HTP_k2_e);
        
        Geo_tier.S_HTP = S_HTP;
        Geo_tier.S_HTP_e = S_e_HTP;
        Geo_tier.S_HTP_s = S_s_HTP;
        Geo_tier.S_HTP_fus = S_fus_HTP;
        Geo_tier.S_HTP_ph = S_ph_HTP;
        Geo_tier.S_HTP_pv = S_pv_HTP;
        
        Geo_tier.AR_HTP = AR_HTP;
        Geo_tier.AR_HTP_e = AR_e_HTP;
        Geo_tier.AR_HTP_s = AR_s_HTP;
        
        Geo_tier.cmac_HTP = XYZ_MAC_HTP.cbar_w;
        Geo_tier.xbar_HTP = XYZ_MAC_HTP.xbar_w;
        Geo_tier.ybar_HTP = XYZ_MAC_HTP.ybar_w;
        Geo_tier.zbar_HTP = XYZ_MAC_HTP.zbar_w;
        
        Geo_tier.cmac_HTP_e = XYZ_MAC_e_HTP.cbar_w;
        Geo_tier.xbar_HTP_e = XYZ_MAC_e_HTP.xbar_w;
        Geo_tier.ybar_HTP_e = XYZ_MAC_e_HTP.ybar_w;
        Geo_tier.zbar_HTP_e = XYZ_MAC_e_HTP.zbar_w;
        
        
    end
    % Distances relative to the origin
    x_xbar_HTP = x_loc_LE_HTP + Geo_tier.xbar_HTP;
    y_ybar_HTP = y_loc_LE_HTP + Geo_tier.ybar_HTP;
    z_zbar_HTP = z_loc_LE_HTP + Geo_tier.zbar_HTP;
    x_xbar_HTP_e = x_loc_LE_HTP + Geo_tier.xbar_HTP_e;
    y_ybar_HTP_e = y_loc_LE_HTP + Geo_tier.ybar_HTP_e;
    z_zbar_HTP_e = z_loc_LE_HTP + Geo_tier.zbar_HTP_e;
    
    % Storing DATA
    Geo_tier.x_xbar_HTP = x_xbar_HTP;
    Geo_tier.y_ybar_HTP = y_ybar_HTP;
    Geo_tier.z_zbar_HTP = z_zbar_HTP;
    Geo_tier.x_xbar_HTP_e = x_xbar_HTP_e;
    Geo_tier.y_ybar_HTP_e = y_ybar_HTP_e;
    Geo_tier.z_zbar_HTP_e = z_zbar_HTP_e;
    

    %% Tail Volume Coefficients
    l_xac_w1HTP = x_xbar_HTP - x_xbar_w1; % from xac_wing1 to xac_wing2
    % tail volume coefficient
    CHTP = S_HTP*l_xac_w1HTP/(Geo_tier.cmac_HTP*S_ref);
    
    lfus_b_HTP = l_fus/b_HTP;
    Geo_tier.lfus_b_HTP = lfus_b_HTP;
    
    % Storing DATA
    Geo_tier.l_xac_w1HTP = l_xac_w1HTP;
    Geo_tier.CHTP = CHTP;
end
...
if Vee == 1 
    ...
    % y1 identifies inner position
    % y2 identifies outer position
    x_loc_1R_y1_vee_CAD = Geo_tier.x_loc_1R_y1_vee_CAD;
    y_loc_1R_y1_vee_CAD = Geo_tier.y_loc_1R_y1_vee_CAD;
    z_loc_1R_y1_vee_CAD = Geo_tier.z_loc_1R_y1_vee_CAD;
    x_loc_1R_y2_vee_CAD = Geo_tier.x_loc_1R_y2_vee_CAD;
    y_loc_1R_y2_vee_CAD = Geo_tier.y_loc_1R_y2_vee_CAD;
    z_loc_1R_y2_vee_CAD = Geo_tier.z_loc_1R_y2_vee_CAD;
    % if Vee == 1
        y_loc_1R_yB1_vee_CAD = Geo_tier.y_loc_1R_yB1_vee_CAD;
        y_loc_1R_yB2_vee_CAD = Geo_tier.y_loc_1R_yB2_vee_CAD;
    % end
    x_y1_y2_vee_CAD = Geo_tier.x_y1_y2_vee_CAD;
    y_y1_y2_vee_CAD = Geo_tier.y_y1_y2_vee_CAD;
    z_y1_y2_vee_CAD = Geo_tier.z_y1_y2_vee_CAD;
    % Wingspan - vee
    b_vee = Geo_tier.b_vee;
    b_vee_e = Geo_tier.b_vee_e;
    b_vee_fus = Geo_tier.b_vee_fus;
    
    % Location of LE vee
    x_loc_LE_vee_CAD = x_loc_1R_y1_vee_CAD; % distance from CAD refference point
    y_loc_LE_vee_CAD = y_loc_1R_y1_vee_CAD; % distance from CAD refference point
    z_loc_LE_vee_CAD = z_loc_1R_y1_vee_CAD; % distance from CAD refference point
    x_loc_LE_vee = x_loc_LE_vee_CAD + x_offset_CAD;
    y_loc_LE_vee = b_vee_fus/2;
    z_loc_LE_vee = z_loc_LE_vee_CAD + z_offset_CAD;
    % Storing DATA
    Geo_tier.x_loc_LE_vee = x_loc_LE_vee;
    Geo_tier.y_loc_LE_vee = y_loc_LE_vee;
    Geo_tier.z_loc_LE_vee = z_loc_LE_vee;
    Geo_tier.x_loc_LE_vee_CAD = x_loc_LE_vee_CAD;
    Geo_tier.y_loc_LE_vee_CAD = y_loc_LE_vee_CAD;
    Geo_tier.z_loc_LE_vee_CAD = z_loc_LE_vee_CAD;
    
    % Location of LE w1 and vee
    x_vee_LE = x_loc_LE_vee;
    y_vee_LE = y_loc_LE_vee;
    z_vee_LE = z_loc_LE_vee;
    % Storing DATA
    Geo_tier.x_vee_LE = x_vee_LE;
    Geo_tier.y_vee_LE = y_vee_LE;
    Geo_tier.z_vee_LE = z_vee_LE;
    
    % Angles
    Lambda_LE_vee = Geo_tier.Lambda_LE_vee;
    dihedral_vee = Geo_tier.dihedral_vee;
    dihedral_vee_e = Geo_tier.dihedral_vee_e;
    % if vee == 1
        Lambda_LE_vee_k1_e = Geo_tier.Lambda_LE_vee_k1_e;
        Lambda_LE_vee_k2_e = Geo_tier.Lambda_LE_vee_k2_e;
        dihedral_vee_k1_e = Geo_tier.dihedral_vee_k1_e;
        dihedral_vee_k2_e = Geo_tier.dihedral_vee_k2_e;
    % end
    ...
    % if vee == 1
        cB_k1_vee = Geo_tier.cB_k1_vee;
        cB_k2_vee = Geo_tier.cB_k2_vee;
    % end
    cT_vee = Geo_tier.cT_vee;
    
    % Wingspan - vee
    b_vee_s = (b_vee_e/cos(abs(dihedral_vee_e)));
    % effective wingspan in y direction
    b_vee_pv = b_vee_s*sin(abs(dihedral_vee_e)); % effective wingspan in vertical direction direction
    
    % Storing Data
    Geo_tier.b_vee_s = b_vee_s;
    Geo_tier.b_vee_pv = b_vee_pv;
        
    % Wing area 2
    S_vee_e = b_vee_e*(cR_vee+cT_vee)/2; % effective wing area: proyected in teh y-plane
    S_vee_s = b_vee_s*(cR_vee+cT_vee)/2; % real wing area: proyected along the surface of wing
    S_vee_fus = cR_vee*b_vee_fus; % vee area within the fuselage
%     S_vee = S_vee_e; % vee Reference area % Cola en V with no fuselage interference
    S_vee = S_vee_e + S_vee_fus; % vee Reference area
    S_vee_ph = S_vee_s*cos(abs(dihedral_vee_e)); % Proyected area of the w1 ino the horizontal plane
    S_vee_pv = S_vee_s*sin(abs(dihedral_vee_e)); % Proyected area of the w1 ino the vertical plane
        
    % Storing DATA
    Geo_tier.S_vee = S_vee;
    Geo_tier.S_vee_e  = S_vee_e;
    Geo_tier.S_vee_s  = S_vee_s;
    Geo_tier.S_vee_fus  = S_vee_fus;
    Geo_tier.S_vee_ph  = S_vee_ph;
    Geo_tier.S_vee_pv  = S_vee_pv;
    
    % Aspect Ratio
    AR_vee = b_vee^2/S_vee;
    AR_vee_e = b_vee_e^2/S_vee_e;
    AR_vee_s = b_vee_s^2/S_vee_s;
    
    % Storing DATA
    Geo_tier.AR_vee = AR_vee;
    Geo_tier.AR_vee_e = AR_vee_e;
    Geo_tier.AR_vee_s = AR_vee_s;
    
    % Taper Ratio
    lambda_vee = cT_vee/cR_vee;
    lambda_vee_e = cT_vee/cR_vee;
    % Storing DATA
    Geo_tier.lambda_vee = lambda_vee;
    Geo_tier.lambda_vee_e = lambda_vee_e;
    
    %% Calculation of Sweep angles
    % Quarter Chord
    Lambda_c4_vee = Get_Nth_Lambda(1/4,AR_vee_e,Lambda_LE_vee,lambda_vee_e);
    % Half chord
    Lambda_c2_vee = Get_Nth_Lambda(1/2,AR_vee_e,Lambda_LE_vee,lambda_vee_e);
    % Trailing Edge
    Lambda_TE_vee = Get_Nth_Lambda(1,AR_vee_e,Lambda_LE_vee,lambda_vee_e);
    % 3/4 of chord
    Lambda_c34_vee = Get_Nth_Lambda(3/4,AR_vee_e,Lambda_LE_vee,lambda_vee_e);
    
    % Storing DATA
    Geo_tier.Lambda_TE_vee  = Lambda_TE_vee;
    Geo_tier.Lambda_TE_vee  = Lambda_TE_vee;
    Geo_tier.Lambda_c4_vee  = Lambda_c4_vee;
    Geo_tier.Lambda_c2_vee  = Lambda_c2_vee;
    Geo_tier.Lambda_c34_vee  = Lambda_c34_vee;
        
    %% Geometric location of the vee in order to define the corners of the surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    x_1R_y1_vee = 0; % defines inner position of wing chord (aileron section) LE
    x_2R_y1_vee = x_1R_y1_vee + cR_vee; % defines inner position of wing chord TE
    % chord at each location
    y_offset_vee = b_vee_fus/2;
    x_1R_y2_vee = x_1R_y1_vee + (b_vee/2 - y_offset_vee)*tan(Lambda_LE_vee); % defines inner position of wing chord (ruddervator section) LE
    x_2R_y2_vee = x_1R_y2_vee + cT_vee; % defines inner position of wing chord TE
    % spanwise location
    y_1R_y1_vee = b_vee/2 - b_vee_e/2; % inner position from the center line
    y_2R_y1_vee = y_1R_y1_vee; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    y_1R_y2_vee = b_vee/2; % outter position from the center line
    y_2R_y2_vee = y_1R_y2_vee; % outter position from the center line (same as LE assumes chord paralel to x-axis)
    % z-position
    z_1R_y1_vee = 0; % inner position from the center line
    z_2R_y1_vee = 0; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    z_1R_y2_vee = z_1R_y1_vee + (b_vee/2 - y_offset_vee)*tan(dihedral_vee);
    z_2R_y2_vee = z_2R_y1_vee + (b_vee/2 - y_offset_vee)*tan(dihedral_vee);
    
    % Storing DATA
    Geo_tier.x_1R_y1_vee = x_1R_y1_vee;
    Geo_tier.x_2R_y1_vee = x_2R_y1_vee;
    Geo_tier.x_1R_y2_vee = x_1R_y2_vee;
    Geo_tier.x_2R_y2_vee = x_2R_y2_vee;
    Geo_tier.y_1R_y1_vee = y_1R_y1_vee;
    Geo_tier.y_2R_y1_vee = y_2R_y1_vee;
    Geo_tier.y_1R_y2_vee = y_1R_y2_vee;
    Geo_tier.y_2R_y2_vee = y_2R_y2_vee;
    Geo_tier.z_1R_y1_vee = z_1R_y1_vee;
    Geo_tier.z_2R_y1_vee = z_2R_y1_vee;
    Geo_tier.z_1R_y2_vee = z_1R_y2_vee;
    Geo_tier.z_2R_y2_vee = z_2R_y2_vee;
    Geo_tier.y_offset_vee = y_offset_vee;
    
    % Position relative to the Origin
    % X-position
    x_cR_vee_LE = x_vee_LE + x_1R_y1_vee;
    x_cR_vee_TE = x_vee_LE + x_2R_y1_vee;
    x_cT_vee_LE = x_vee_LE + x_1R_y2_vee;
    x_cT_vee_TE = x_vee_LE + x_2R_y2_vee;
    % Y-position
    y_cR_vee_LE = y_offset_vee;
    y_cR_vee_TE = y_cR_vee_LE;
    y_cT_vee_LE = y_cR_vee_LE + b_vee_e/2;
    y_cT_vee_TE = y_cT_vee_LE;
    % Z-position
    
    z_cR_vee_LE = z_loc_LE_vee + z_1R_y1_vee; % inner position from the center line
    z_cT_vee_LE = z_loc_LE_vee + z_1R_y2_vee; % inner position from the center line
    z_cR_vee_TE = z_loc_LE_vee + z_2R_y1_vee;
    z_cT_vee_TE = z_loc_LE_vee + z_2R_y2_vee;
    
    % Storing DATA
    Geo_tier.x_cR_vee_LE = x_cR_vee_LE;
    Geo_tier.x_cR_vee_TE = x_cR_vee_TE;
    Geo_tier.x_cT_vee_LE = x_cT_vee_LE;
    Geo_tier.x_cT_vee_TE = x_cT_vee_TE;
    Geo_tier.y_cR_vee_LE = y_cR_vee_LE;
    Geo_tier.y_cT_vee_LE = y_cT_vee_LE;
    Geo_tier.y_cR_vee_TE = y_cR_vee_TE;
    Geo_tier.y_cT_vee_TE = y_cT_vee_TE;
    Geo_tier.z_cR_vee_LE = z_cR_vee_LE;
    Geo_tier.z_cT_vee_LE = z_cT_vee_LE;
    Geo_tier.z_cR_vee_TE = z_cR_vee_TE;
    Geo_tier.z_cT_vee_TE = z_cT_vee_TE;

    % Geometric position of vee MAC
    XYZ_MAC = Get_MAC_Coordinates(b_vee,lambda_vee,cR_vee,dihedral_vee,Lambda_c4_vee);
    Geo_tier.cmac_vee = XYZ_MAC.cbar;
    Geo_tier.xbar_vee = XYZ_MAC.xbar_w;
    Geo_tier.ybar_vee = XYZ_MAC.ybar_w;
    Geo_tier.zbar_vee = XYZ_MAC.zbar_w;
    
    % Geometric position of vee MAC
    XYZ_MAC = Get_MAC_Coordinates(b_vee_e,lambda_vee_e,cR_vee,dihedral_vee,Lambda_c4_vee);
    Geo_tier.cmac_vee_e = XYZ_MAC.cbar;
    Geo_tier.xbar_vee_e = XYZ_MAC.xbar_w;
    Geo_tier.ybar_vee_e = XYZ_MAC.ybar_w;
    Geo_tier.zbar_vee_e = XYZ_MAC.zbar_w;
    
    % if vee == 1
        [S_e_vee, S_vee, S_s_vee, S_fus_vee, S_ph_vee, S_pv_vee, AR_vee, AR_e_vee, AR_s_vee, XYZ_MAC_vee, ...
            XYZ_MAC_e_vee] = get_crankedwing_geom_airbus_method(cR_vee, cB_k1_vee, cB_k2_vee, cT_vee,...
            y_loc_LE_vee_CAD, y_loc_1R_yB1_vee_CAD, y_loc_1R_yB2_vee_CAD, y_loc_1R_y2_vee_CAD, ...
            Lambda_LE_vee, Lambda_LE_vee_k1_e , Lambda_LE_vee_k2_e, dihedral_vee, dihedral_vee_k1_e, dihedral_vee_k2_e);
        
        Geo_tier.S_vee = S_vee;
        Geo_tier.S_vee_e = S_e_vee;
        Geo_tier.S_vee_s = S_s_vee;
        Geo_tier.S_vee_fus = S_fus_vee;
        Geo_tier.S_vee_ph = S_ph_vee;
        Geo_tier.S_vee_pv = S_pv_vee;
        
        Geo_tier.AR_vee = AR_vee;
        Geo_tier.AR_vee_e = AR_e_vee;
        Geo_tier.AR_vee_s = AR_s_vee;
        
        Geo_tier.cmac_vee = XYZ_MAC_vee.cbar_w;
        Geo_tier.xbar_vee = XYZ_MAC_vee.xbar_w;
        Geo_tier.ybar_vee = XYZ_MAC_vee.ybar_w;
        Geo_tier.zbar_vee = XYZ_MAC_vee.zbar_w;
        
        Geo_tier.cmac_vee_e = XYZ_MAC_e_vee.cbar_w;
        Geo_tier.xbar_vee_e = XYZ_MAC_e_vee.xbar_w;
        Geo_tier.ybar_vee_e = XYZ_MAC_e_vee.ybar_w;
        Geo_tier.zbar_vee_e = XYZ_MAC_e_vee.zbar_w;
        
        
    % end
    % Distances relative to the origin
    x_xbar_vee = x_loc_LE_vee + Geo_tier.xbar_vee;
    y_ybar_vee = y_loc_LE_vee + Geo_tier.ybar_vee;
    z_zbar_vee = z_loc_LE_vee + Geo_tier.zbar_vee;
    x_xbar_vee_e = x_loc_LE_vee + Geo_tier.xbar_vee_e;
    y_ybar_vee_e = y_loc_LE_vee + Geo_tier.ybar_vee_e;
    z_zbar_vee_e = z_loc_LE_vee + Geo_tier.zbar_vee_e;
    
    % Storing DATA
    Geo_tier.x_xbar_vee = x_xbar_vee;
    Geo_tier.y_ybar_vee = y_ybar_vee;
    Geo_tier.z_zbar_vee = z_zbar_vee;
    Geo_tier.x_xbar_vee_e = x_xbar_vee_e;
    Geo_tier.y_ybar_vee_e = y_ybar_vee_e;
    Geo_tier.z_zbar_vee_e = z_zbar_vee_e;
    

    %% Tail Volume Coefficients
    l_xac_w1vee = x_xbar_vee - x_xbar_w1; % from xac_wing1 to xac_wing2
    % tail volume coefficient
    Cvee = S_vee*l_xac_w1vee/(Geo_tier.cmac_vee*S_ref);
    
    lfus_b_vee = l_fus/b_vee;
    Geo_tier.lfus_b_vee = lfus_b_vee;
    
    % Storing DATA
    Geo_tier.l_xac_w1vee = l_xac_w1vee;
    Geo_tier.Cvee = Cvee;
end
...
if Vee2 == 1 
    ...
    % y1 identifies inner position
    % y2 identifies outer position
    x_loc_1R_y1_vee2_CAD = Geo_tier.x_loc_1R_y1_vee2_CAD;
    y_loc_1R_y1_vee2_CAD = Geo_tier.y_loc_1R_y1_vee2_CAD;
    z_loc_1R_y1_vee2_CAD = Geo_tier.z_loc_1R_y1_vee2_CAD;
    x_loc_1R_y2_vee2_CAD = Geo_tier.x_loc_1R_y2_vee2_CAD;
    y_loc_1R_y2_vee2_CAD = Geo_tier.y_loc_1R_y2_vee2_CAD;
    z_loc_1R_y2_vee2_CAD = Geo_tier.z_loc_1R_y2_vee2_CAD;
    % if vee2 == 1
        y_loc_1R_yB1_vee2_CAD = Geo_tier.y_loc_1R_yB1_vee2_CAD;
        y_loc_1R_yB2_vee2_CAD = Geo_tier.y_loc_1R_yB2_vee2_CAD;
    % end
    x_y1_y2_vee2_CAD = Geo_tier.x_y1_y2_vee2_CAD;
    y_y1_y2_vee2_CAD = Geo_tier.y_y1_y2_vee2_CAD;
    z_y1_y2_vee2_CAD = Geo_tier.z_y1_y2_vee2_CAD;
    % Wingspan - vee2
    b_vee2 = Geo_tier.b_vee2;
    b_vee2_e = Geo_tier.b_vee2_e;
    b_vee2_fus = Geo_tier.b_vee2_fus;
    
    % Location of LE vee2
    x_loc_LE_vee2_CAD = x_loc_1R_y1_vee2_CAD; % distance from CAD refference point
    y_loc_LE_vee2_CAD = y_loc_1R_y1_vee2_CAD; % distance from CAD refference point
    z_loc_LE_vee2_CAD = z_loc_1R_y1_vee2_CAD; % distance from CAD refference point
    x_loc_LE_vee2 = x_loc_LE_vee2_CAD + x_offset_CAD;
    y_loc_LE_vee2 = b_vee2_fus/2;
    z_loc_LE_vee2 = z_loc_LE_vee2_CAD + z_offset_CAD;
    % Storing DATA
    Geo_tier.x_loc_LE_vee2 = x_loc_LE_vee2;
    Geo_tier.y_loc_LE_vee2 = y_loc_LE_vee2;
    Geo_tier.z_loc_LE_vee2 = z_loc_LE_vee2;
    Geo_tier.x_loc_LE_vee2_CAD = x_loc_LE_vee2_CAD;
    Geo_tier.y_loc_LE_vee2_CAD = y_loc_LE_vee2_CAD;
    Geo_tier.z_loc_LE_vee2_CAD = z_loc_LE_vee2_CAD;
    
    % Location of LE w1 and vee2
    x_vee2_LE = x_loc_LE_vee2;
    y_vee2_LE = y_loc_LE_vee2;
    z_vee2_LE = z_loc_LE_vee2;
    % Storing DATA
    Geo_tier.x_vee2_LE = x_vee2_LE;
    Geo_tier.y_vee2_LE = y_vee2_LE;
    Geo_tier.z_vee2_LE = z_vee2_LE;
    
    % Angles
    Lambda_LE_vee2 = Geo_tier.Lambda_LE_vee2;
    dihedral_vee2 = Geo_tier.dihedral_vee2;
    dihedral_vee2_e = Geo_tier.dihedral_vee2_e;
    % if vee2 == 1
        Lambda_LE_vee2_k1_e = Geo_tier.Lambda_LE_vee2_k1_e;
        Lambda_LE_vee2_k2_e = Geo_tier.Lambda_LE_vee2_k2_e;
        dihedral_vee2_k1_e = Geo_tier.dihedral_vee2_k1_e;
        dihedral_vee2_k2_e = Geo_tier.dihedral_vee2_k2_e;
    % end
    ...
    % if vee2 == 1
        cB_k1_vee2 = Geo_tier.cB_k1_vee2;
        cB_k2_vee2 = Geo_tier.cB_k2_vee2;
    % end
    cT_vee2 = Geo_tier.cT_vee2;
    
    % Wingspan - vee2
    b_vee2_s = (b_vee2_e/cos(abs(dihedral_vee2_e)));
    % effective wingspan in y direction
    b_vee2_pv = b_vee2_s*sin(abs(dihedral_vee2_e)); % effective wingspan in vertical direction direction
    
    % Storing Data
    Geo_tier.b_vee2_s = b_vee2_s;
    Geo_tier.b_vee2_pv = b_vee2_pv;
        
    % Wing area 2
    S_vee2_e = b_vee2_e*(cR_vee2+cT_vee2)/2; % effective wing area: proyected in teh y-plane
    S_vee2_s = b_vee2_s*(cR_vee2+cT_vee2)/2; % real wing area: proyected along the surface of wing
    S_vee2_fus = cR_vee2*b_vee2_fus; % vee2 area within the fuselage
%     S_vee2 = S_vee2_e; % vee2 Reference area % Cola en V with no fuselage interference
    S_vee2 = S_vee2_e + S_vee2_fus; % vee2 Reference area
    S_vee2_ph = S_vee2_s*cos(abs(dihedral_vee2_e)); % Proyected area of the w1 ino the horizontal plane
    S_vee2_pv = S_vee2_s*sin(abs(dihedral_vee2_e)); % Proyected area of the w1 ino the vertical plane
        
    % Storing DATA
    Geo_tier.S_vee2 = S_vee2;
    Geo_tier.S_vee2_e  = S_vee2_e;
    Geo_tier.S_vee2_s  = S_vee2_s;
    Geo_tier.S_vee2_fus  = S_vee2_fus;
    Geo_tier.S_vee2_ph  = S_vee2_ph;
    Geo_tier.S_vee2_pv  = S_vee2_pv;
    
    % Aspect Ratio
    AR_vee2 = b_vee2^2/S_vee2;
    AR_vee2_e = b_vee2_e^2/S_vee2_e;
    AR_vee2_s = b_vee2_s^2/S_vee2_s;
    
    % Storing DATA
    Geo_tier.AR_vee2 = AR_vee2;
    Geo_tier.AR_vee2_e = AR_vee2_e;
    Geo_tier.AR_vee2_s = AR_vee2_s;
    
    % Taper Ratio
    lambda_vee2 = cT_vee2/cR_vee2;
    lambda_vee2_e = cT_vee2/cR_vee2;
    % Storing DATA
    Geo_tier.lambda_vee2 = lambda_vee2;
    Geo_tier.lambda_vee2_e = lambda_vee2_e;
    
    %% Calculation of Sweep angles
    % Quarter Chord
    Lambda_c4_vee2 = Get_Nth_Lambda(1/4,AR_vee2_e,Lambda_LE_vee2,lambda_vee2_e);
    % Half chord
    Lambda_c2_vee2 = Get_Nth_Lambda(1/2,AR_vee2_e,Lambda_LE_vee2,lambda_vee2_e);
    % Trailing Edge
    Lambda_TE_vee2 = Get_Nth_Lambda(1,AR_vee2_e,Lambda_LE_vee2,lambda_vee2_e);
    % 3/4 of chord
    Lambda_c34_vee2 = Get_Nth_Lambda(3/4,AR_vee2_e,Lambda_LE_vee2,lambda_vee2_e);
    
    % Storing DATA
    Geo_tier.Lambda_TE_vee2  = Lambda_TE_vee2;
    Geo_tier.Lambda_TE_vee2  = Lambda_TE_vee2;
    Geo_tier.Lambda_c4_vee2  = Lambda_c4_vee2;
    Geo_tier.Lambda_c2_vee2  = Lambda_c2_vee2;
    Geo_tier.Lambda_c34_vee2  = Lambda_c34_vee2;
        
    %% Geometric location of the vee2 in order to define the corners of the surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    x_1R_y1_vee2 = 0; % defines inner position of wing chord (aileron section) LE
    x_2R_y1_vee2 = x_1R_y1_vee2 + cR_vee2; % defines inner position of wing chord TE
    % chord at each location
    y_offset_vee2 = b_vee2_fus/2;
    x_1R_y2_vee2 = x_1R_y1_vee2 + (b_vee2/2 - y_offset_vee2)*tan(Lambda_LE_vee2); % defines inner position of wing chord (ruddervator section) LE
    x_2R_y2_vee2 = x_1R_y2_vee2 + cT_vee2; % defines inner position of wing chord TE
    % spanwise location
    y_1R_y1_vee2 = b_vee2/2 - b_vee2_e/2; % inner position from the center line
    y_2R_y1_vee2 = y_1R_y1_vee2; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    y_1R_y2_vee2 = b_vee2/2; % outter position from the center line
    y_2R_y2_vee2 = y_1R_y2_vee2; % outter position from the center line (same as LE assumes chord paralel to x-axis)
    % z-position
    z_1R_y1_vee2 = 0; % inner position from the center line
    z_2R_y1_vee2 = 0; % inner position from the center line (same as LE assumes chord paralel to x-axis)
    z_1R_y2_vee2 = z_1R_y1_vee2 + (b_vee2/2 - y_offset_vee2)*tan(dihedral_vee2);
    z_2R_y2_vee2 = z_2R_y1_vee2 + (b_vee2/2 - y_offset_vee2)*tan(dihedral_vee2);
    
    % Storing DATA
    Geo_tier.x_1R_y1_vee2 = x_1R_y1_vee2;
    Geo_tier.x_2R_y1_vee2 = x_2R_y1_vee2;
    Geo_tier.x_1R_y2_vee2 = x_1R_y2_vee2;
    Geo_tier.x_2R_y2_vee2 = x_2R_y2_vee2;
    Geo_tier.y_1R_y1_vee2 = y_1R_y1_vee2;
    Geo_tier.y_2R_y1_vee2 = y_2R_y1_vee2;
    Geo_tier.y_1R_y2_vee2 = y_1R_y2_vee2;
    Geo_tier.y_2R_y2_vee2 = y_2R_y2_vee2;
    Geo_tier.z_1R_y1_vee2 = z_1R_y1_vee2;
    Geo_tier.z_2R_y1_vee2 = z_2R_y1_vee2;
    Geo_tier.z_1R_y2_vee2 = z_1R_y2_vee2;
    Geo_tier.z_2R_y2_vee2 = z_2R_y2_vee2;
    Geo_tier.y_offset_vee2 = y_offset_vee2;
    
    % Position relative to the Origin
    % X-position
    x_cR_vee2_LE = x_vee2_LE + x_1R_y1_vee2;
    x_cR_vee2_TE = x_vee2_LE + x_2R_y1_vee2;
    x_cT_vee2_LE = x_vee2_LE + x_1R_y2_vee2;
    x_cT_vee2_TE = x_vee2_LE + x_2R_y2_vee2;
    % Y-position
    y_cR_vee2_LE = y_offset_vee2;
    y_cR_vee2_TE = y_cR_vee2_LE;
    y_cT_vee2_LE = y_cR_vee2_LE + b_vee2_e/2;
    y_cT_vee2_TE = y_cT_vee2_LE;
    % Z-position
    
    z_cR_vee2_LE = z_loc_LE_vee2 + z_1R_y1_vee2; % inner position from the center line
    z_cT_vee2_LE = z_loc_LE_vee2 + z_1R_y2_vee2; % inner position from the center line
    z_cR_vee2_TE = z_loc_LE_vee2 + z_2R_y1_vee2;
    z_cT_vee2_TE = z_loc_LE_vee2 + z_2R_y2_vee2;
    
    % Storing DATA
    Geo_tier.x_cR_vee2_LE = x_cR_vee2_LE;
    Geo_tier.x_cR_vee2_TE = x_cR_vee2_TE;
    Geo_tier.x_cT_vee2_LE = x_cT_vee2_LE;
    Geo_tier.x_cT_vee2_TE = x_cT_vee2_TE;
    Geo_tier.y_cR_vee2_LE = y_cR_vee2_LE;
    Geo_tier.y_cT_vee2_LE = y_cT_vee2_LE;
    Geo_tier.y_cR_vee2_TE = y_cR_vee2_TE;
    Geo_tier.y_cT_vee2_TE = y_cT_vee2_TE;
    Geo_tier.z_cR_vee2_LE = z_cR_vee2_LE;
    Geo_tier.z_cT_vee2_LE = z_cT_vee2_LE;
    Geo_tier.z_cR_vee2_TE = z_cR_vee2_TE;
    Geo_tier.z_cT_vee2_TE = z_cT_vee2_TE;

    % Geometric position of vee2 MAC
    XYZ_MAC = Get_MAC_Coordinates(b_vee2,lambda_vee2,cR_vee2,dihedral_vee2,Lambda_c4_vee2);
    Geo_tier.cmac_vee2 = XYZ_MAC.cbar;
    Geo_tier.xbar_vee2 = XYZ_MAC.xbar_w;
    Geo_tier.ybar_vee2 = XYZ_MAC.ybar_w;
    Geo_tier.zbar_vee2 = XYZ_MAC.zbar_w;
    
    % Geometric position of vee2 MAC
    XYZ_MAC = Get_MAC_Coordinates(b_vee2_e,lambda_vee2_e,cR_vee2,dihedral_vee2,Lambda_c4_vee2);
    Geo_tier.cmac_vee2_e = XYZ_MAC.cbar;
    Geo_tier.xbar_vee2_e = XYZ_MAC.xbar_w;
    Geo_tier.ybar_vee2_e = XYZ_MAC.ybar_w;
    Geo_tier.zbar_vee2_e = XYZ_MAC.zbar_w;
    
    % if vee2 == 1
        [S_e_vee2, S_vee2, S_s_vee2, S_fus_vee2, S_ph_vee2, S_pv_vee2, AR_vee2, AR_e_vee2, AR_s_vee2, XYZ_MAC_vee2, ...
            XYZ_MAC_e_vee2] = get_crankedwing_geom_airbus_method(cR_vee2, cB_k1_vee2, cB_k2_vee2, cT_vee2,...
            y_loc_LE_vee2_CAD, y_loc_1R_yB1_vee2_CAD, y_loc_1R_yB2_vee2_CAD, y_loc_1R_y2_vee2_CAD, ...
            Lambda_LE_vee2, Lambda_LE_vee2_k1_e , Lambda_LE_vee2_k2_e, dihedral_vee2, dihedral_vee2_k1_e, dihedral_vee2_k2_e);
        
        Geo_tier.S_vee2 = S_vee2;
        Geo_tier.S_vee2_e = S_e_vee2;
        Geo_tier.S_vee2_s = S_s_vee2;
        Geo_tier.S_vee2_fus = S_fus_vee2;
        Geo_tier.S_vee2_ph = S_ph_vee2;
        Geo_tier.S_vee2_pv = S_pv_vee2;
        
        Geo_tier.AR_vee2 = AR_vee2;
        Geo_tier.AR_vee2_e = AR_e_vee2;
        Geo_tier.AR_vee2_s = AR_s_vee2;
        
        Geo_tier.cmac_vee2 = XYZ_MAC_vee2.cbar_w;
        Geo_tier.xbar_vee2 = XYZ_MAC_vee2.xbar_w;
        Geo_tier.ybar_vee2 = XYZ_MAC_vee2.ybar_w;
        Geo_tier.zbar_vee2 = XYZ_MAC_vee2.zbar_w;
        
        Geo_tier.cmac_vee2_e = XYZ_MAC_e_vee2.cbar_w;
        Geo_tier.xbar_vee2_e = XYZ_MAC_e_vee2.xbar_w;
        Geo_tier.ybar_vee2_e = XYZ_MAC_e_vee2.ybar_w;
        Geo_tier.zbar_vee2_e = XYZ_MAC_e_vee2.zbar_w;
        
        
    % end
    % Distances relative to the origin
    x_xbar_vee2 = x_loc_LE_vee2 + Geo_tier.xbar_vee2;
    y_ybar_vee2 = y_loc_LE_vee2 + Geo_tier.ybar_vee2;
    z_zbar_vee2 = z_loc_LE_vee2 + Geo_tier.zbar_vee2;
    x_xbar_vee2_e = x_loc_LE_vee2 + Geo_tier.xbar_vee2_e;
    y_ybar_vee2_e = y_loc_LE_vee2 + Geo_tier.ybar_vee2_e;
    z_zbar_vee2_e = z_loc_LE_vee2 + Geo_tier.zbar_vee2_e;
    
    % Storing DATA
    Geo_tier.x_xbar_vee2 = x_xbar_vee2;
    Geo_tier.y_ybar_vee2 = y_ybar_vee2;
    Geo_tier.z_zbar_vee2 = z_zbar_vee2;
    Geo_tier.x_xbar_vee2_e = x_xbar_vee2_e;
    Geo_tier.y_ybar_vee2_e = y_ybar_vee2_e;
    Geo_tier.z_zbar_vee2_e = z_zbar_vee2_e;
    

    %% Tail Volume Coefficients
    l_xac_w1vee2 = x_xbar_vee2 - x_xbar_w1; % from xac_wing1 to xac_wing2
    % tail volume coefficient
    Cvee2 = S_vee2*l_xac_w1vee2/(Geo_tier.cmac_vee2*S_ref);
    
    lfus_b_vee2 = l_fus/b_vee2;
    Geo_tier.lfus_b_vee2 = lfus_b_vee2;
    
    % Storing DATA
    Geo_tier.l_xac_w1vee2 = l_xac_w1vee2;
    Geo_tier.Cvee2 = Cvee2;
end
...
%     y_offset_VTP = b_VTP_fus/2;
    ...
    Geo_tier.lfus_b_VTP = lfus_b_VTP;
...
%     else       
    ...
    b_ele = b_HTP_e*K_ele; % length of aileron's (both surfaces)
    % inner and outter location of the control surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    y_1R_y1_ele = y_offset_HTP + (b_HTP_e/2)*K_y1_ele_HTP; % inner position from the center line
    y_2R_y1_ele = y_1R_y1_ele; % inner position from the center line
    y_1R_y2_ele = y_offset_HTP + (b_HTP_e/2)*K_y2_ele_HTP; % outter position from the center line
    ...
    CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_ele,y_2R_y1_ele,y_1R_y2_ele,y_2R_y2_ele,...
        x_1R_y1_HTP,x_2R_y1_HTP,y_offset_HTP,Lambda_LE_HTP,Lambda_TE_HTP,Lambda_c4_HTP,dihedral_HTP,cf_ele,AC_CONFIGURATION,VTP_cs);
    ...
    % Distances relative to the origin
    x_xbar_ele = x_loc_LE_HTP + CS_geo.xbar_cs;
    y_ybar_ele = y_loc_LE_HTP + CS_geo.ybar_cs;
    z_zbar_ele = z_loc_LE_HTP + CS_geo.ybar_cs;
    % Store DATA
...
if d_rudvtr == 1
    ...
    b_rudvtr = b_vee_e*K_rudvtr; % length of flap (both surfaces)
    % inner and outter location of the control surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    y_1R_y1_rudvtr = y_offset_vee + (b_vee_e/2)*K_y1_rudvtr_vee; % inner position from the center line
    y_2R_y1_rudvtr = y_1R_y1_rudvtr; % inner position from the center line
    y_1R_y2_rudvtr = y_offset_vee + (b_vee_e/2)*K_y2_rudvtr_vee; % outter position from the center line
    ...
    CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_rudvtr,y_2R_y1_rudvtr,y_1R_y2_rudvtr,y_2R_y2_rudvtr,...
        x_1R_y1_vee,x_2R_y1_vee,y_offset_vee,Lambda_LE_vee,Lambda_TE_vee,Lambda_c4_vee,dihedral_vee,cf_rudvtr,AC_CONFIGURATION,VTP_cs);
    ...
    % Distances relative to the origin
    x_xbar_rudvtr = x_loc_LE_vee + CS_geo.xbar_cs;
    y_ybar_rudvtr = y_loc_LE_vee + CS_geo.ybar_cs;
    z_zbar_rudvtr = z_loc_LE_vee + CS_geo.ybar_cs;
...
if d_rudvtr2 == 1
    ...
    b_rudvtr2 = b_vee2_e*K_rudvtr2; % length of flap (both surfaces)
    % inner and outter location of the control surface
    % 1R identifies LE
    % 2R identifies TE
    % y1 identifies inner position
    % y2 identifies outer position
    y_1R_y1_rudvtr2 = y_offset_vee2 + (b_vee2_e/2)*K_y1_rudvtr_vee2; % inner position from the center line
    y_2R_y1_rudvtr2 = y_1R_y1_rudvtr2; % inner position from the center line
    y_1R_y2_rudvtr2 = y_offset_vee2 + (b_vee2_e/2)*K_y2_rudvtr_vee2; % outter position from the center line
    y_2R_y2_rudvtr2 = y_1R_y2_rudvtr2; % outter position from the center line
    
    % Calculates geometric information regarding the control surfaces
    CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_rudvtr2,y_2R_y1_rudvtr2,y_1R_y2_rudvtr2,y_2R_y2_rudvtr2,...
        x_1R_y1_vee2,x_2R_y1_vee2,y_offset_vee2,Lambda_LE_vee2,Lambda_TE_vee2,Lambda_c4_vee2,dihedral_vee2,cf_rudvtr2,AC_CONFIGURATION,VTP_cs);
    
    Geo_tier.cmac_rudvtr2 = CS_geo.cmac_cs;
    Geo_tier.xbar_rudvtr2 = CS_geo.xbar_cs;
    Geo_tier.ybar_rudvtr2 = CS_geo.ybar_cs;
    Geo_tier.zbar_rudvtr2 = CS_geo.zbar_cs;
    
    % Distances relative to the origin
    x_xbar_rudvtr2 = x_loc_LE_vee2 + CS_geo.xbar_cs;
    y_ybar_rudvtr2 = y_loc_LE_vee2 + CS_geo.ybar_cs;
    z_zbar_rudvtr2 = z_loc_LE_vee2 + CS_geo.ybar_cs;
    
    % Store DATA
    Geo_tier.x_xbar_rudvtr2 = x_xbar_rudvtr2;
    Geo_tier.y_ybar_rudvtr2 = y_ybar_rudvtr2;
    Geo_tier.z_zbar_rudvtr2 = z_zbar_rudvtr2;
    Geo_tier.x_1R_y1_rudvtr2 = CS_geo.x_1R_y1_cs;
    Geo_tier.x_2R_y1_rudvtr2 = CS_geo.x_2R_y1_cs;
    Geo_tier.x_1R_y2_rudvtr2 = CS_geo.x_1R_y2_cs;
    Geo_tier.x_2R_y2_rudvtr2 = CS_geo.x_2R_y2_cs;
    Geo_tier.y_1R_y1_rudvtr2 = CS_geo.y_1R_y1_cs;
    Geo_tier.y_2R_y1_rudvtr2 = CS_geo.y_2R_y1_cs;
    Geo_tier.y_1R_y2_rudvtr2 = CS_geo.y_1R_y2_cs;
    Geo_tier.y_2R_y2_rudvtr2 = CS_geo.y_2R_y2_cs;
    Geo_tier.z_1R_y1_rudvtr2 = CS_geo.z_1R_y1_cs;
    Geo_tier.z_2R_y1_rudvtr2 = CS_geo.z_2R_y1_cs;
    Geo_tier.z_1R_y2_rudvtr2 = CS_geo.z_1R_y2_cs;
    Geo_tier.z_2R_y2_rudvtr2 = CS_geo.z_2R_y2_cs;
    Geo_tier.cR_rudvtr2 = CS_geo.c_y1_cs;
    Geo_tier.cT_rudvtr2 = CS_geo.c_y2_cs;
    Geo_tier.b_rudvtr2 = CS_geo.b_cs;
    Geo_tier.S_rudvtr2 = CS_geo.S_cs;
    Geo_tier.S_rudvtr2 = CS_geo.S_cs;
end
...
switch Engine_conf
    case 1 % Engine_conf = 1 - pusher prop
        ...
        if HTP == 1 
            S_HTP_pw = 0;
            Geo_tier.S_HTP_pw = S_HTP_pw;
            
            % % Checks if there is prop wash affecting HTP
            if y_y1_prop_dw < y_cT_HTP_LE
                
                % Estimation of the corners of the affected HTP surface affected by prop
                % wash
                x_1R_y1_HTP_pw = x_1R_y1_HTP + (y_y1_prop_dw - y_offset_HTP)*tan(Lambda_LE_HTP); % defines inner position of wing affeted by proopwash
                x_2R_y1_HTP_pw = x_2R_y1_HTP + (y_y1_prop_dw - y_offset_HTP)*tan(Lambda_TE_HTP); % defines inner position of wing affeted by proopwash
                x_1R_y2_HTP_pw = x_cT_HTP_LE;
                x_2R_y2_HTP_pw = x_cT_HTP_TE;
                % Chord
                c_y1_HTP_pw = x_2R_y1_HTP_pw - x_1R_y1_HTP_pw; % defines chord of wing at beginning of prop wash surface
                c_y2_HTP_pw = x_2R_y2_HTP_pw - x_1R_y2_HTP_pw; % defines chord of wing at beginning of prop wash surface
                % Storing DATA
                Geo_tier.x_1R_y1_HTP_pw = x_1R_y1_HTP_pw;
                Geo_tier.x_2R_y1_HTP_pw = x_2R_y1_HTP_pw;
                Geo_tier.x_1R_y2_HTP_pw = x_1R_y2_HTP_pw;
                Geo_tier.x_2R_y2_HTP_pw = x_2R_y2_HTP_pw;
                Geo_tier.c_y1_HTP_pw = c_y1_HTP_pw;
                Geo_tier.c_y2_HTP_pw = c_y2_HTP_pw;
                % y-location
                y_1R_y1_HTP_pw = y_y1_prop_dw;
                y_2R_y1_HTP_pw = y_y1_prop_dw;
                y_1R_y2_HTP_pw = y_cT_HTP_LE;
                y_2R_y2_HTP_pw = y_cT_HTP_TE;
                % Storing DATA
                Geo_tier.y_1R_y1_HTP_pw = y_1R_y1_HTP_pw;
                Geo_tier.y_2R_y1_HTP_pw = y_2R_y1_HTP_pw;
                Geo_tier.y_1R_y2_HTP_pw = y_1R_y2_HTP_pw;
                Geo_tier.y_2R_y2_HTP_pw = y_2R_y2_HTP_pw;
                
                % Geometry
                lambda_HTP_pw = c_y2_HTP_pw/c_y1_HTP_pw; % HTP prop wash taper ratio
                b_HTP_pw = y_1R_y2_HTP_pw - y_1R_y1_HTP_pw; % same span
                S_HTP_pw = b_HTP_pw*((c_y1_HTP_pw + c_y2_HTP_pw)/2); % total area effective surface
                
                b_HTP_pw = D_prop; % same span
                S_HTP_pw = b_HTP_pw*((c_y1_HTP_pw + c_y2_HTP_pw)/2); % total area effective surface
                ...
                AR_HTP_pw = b_HTP_pw^2/S_HTP_pw; % Aspect Ratio
                % Storing DATA
                Geo_tier.lambda_HTP_pw = lambda_HTP_pw;
                Geo_tier.b_HTP_pw = b_HTP_pw;
                Geo_tier.S_HTP_pw = S_HTP_pw;
                Geo_tier.AR_HTP_pw = AR_HTP_pw;
        ...
        if Vee == 1
            S_vee_pw = 0;
            Geo_tier.S_vee_pw = S_vee_pw;
            
            % % Checks if there is prop wash affecting vee
            if y_y1_prop_dw < y_cT_vee_LE
                
                % Estimation of the corners of the affected vee surface affected by prop
                % wash
                x_1R_y1_vee_pw = x_1R_y1_vee + (y_y1_prop_dw - y_offset_vee)*tan(Lambda_LE_vee); % defines inner position of wing affeted by proopwash
                x_2R_y1_vee_pw = x_2R_y1_vee + (y_y1_prop_dw - y_offset_vee)*tan(Lambda_TE_vee); % defines inner position of wing affeted by proopwash
                x_1R_y2_vee_pw = x_cT_vee_LE;
                x_2R_y2_vee_pw = x_cT_vee_TE;
                % Chord
                c_y1_vee_pw = x_2R_y1_vee_pw - x_1R_y1_vee_pw; % defines chord of wing at beginning of prop wash surface
                c_y2_vee_pw = x_2R_y2_vee_pw - x_1R_y2_vee_pw; % defines chord of wing at beginning of prop wash surface
                % Storing DATA
                Geo_tier.x_1R_y1_vee_pw = x_1R_y1_vee_pw;
                Geo_tier.x_2R_y1_vee_pw = x_2R_y1_vee_pw;
                Geo_tier.x_1R_y2_vee_pw = x_1R_y2_vee_pw;
                Geo_tier.x_2R_y2_vee_pw = x_2R_y2_vee_pw;
                Geo_tier.c_y1_vee_pw = c_y1_vee_pw;
                Geo_tier.c_y2_vee_pw = c_y2_vee_pw;
                % y-location
                y_1R_y1_vee_pw = y_y1_prop_dw;
                y_2R_y1_vee_pw = y_y1_prop_dw;
                y_1R_y2_vee_pw = y_cT_vee_LE;
                y_2R_y2_vee_pw = y_cT_vee_TE;
                % Storing DATA
                Geo_tier.y_1R_y1_vee_pw = y_1R_y1_vee_pw;
                Geo_tier.y_2R_y1_vee_pw = y_2R_y1_vee_pw;
                Geo_tier.y_1R_y2_vee_pw = y_1R_y2_vee_pw;
                Geo_tier.y_2R_y2_vee_pw = y_2R_y2_vee_pw;
                
                % Geometry
                lambda_vee_pw = c_y2_vee_pw/c_y1_vee_pw; % vee prop wash taper ratio
                b_vee_pw = y_1R_y2_vee_pw - y_1R_y1_vee_pw; % same span
                S_vee_pw = b_vee_pw*((c_y1_vee_pw + c_y2_vee_pw)/2); % total area effective surface
                
                b_vee_pw = D_prop; % same span
                S_vee_pw = b_vee_pw*((c_y1_vee_pw + c_y2_vee_pw)/2); % total area effective surface
                ...
                AR_vee_pw = b_vee_pw^2/S_vee_pw; % Aspect Ratio
                % Storing DATA
                Geo_tier.lambda_vee_pw = lambda_vee_pw;
                Geo_tier.b_vee_pw = b_vee_pw;
                Geo_tier.S_vee_pw = S_vee_pw;
                Geo_tier.AR_vee_pw = AR_vee_pw;
        ...
        if Vee2 == 1
            S_vee2_pw = 0;
            Geo_tier.S_vee2_pw = S_vee2_pw;
            
            % % Checks if there is prop wash affecting vee2
            if y_y1_prop_dw < y_cT_vee2_LE
                
                % Estimation of the corners of the affected vee2 surface affected by prop
                % wash
                x_1R_y1_vee2_pw = x_1R_y1_vee2 + (y_y1_prop_dw - y_offset_vee2)*tan(Lambda_LE_vee2); % defines inner position of wing affeted by proopwash
                x_2R_y1_vee2_pw = x_2R_y1_vee2 + (y_y1_prop_dw - y_offset_vee2)*tan(Lambda_TE_vee2); % defines inner position of wing affeted by proopwash
                x_1R_y2_vee2_pw = x_cT_vee2_LE;
                x_2R_y2_vee2_pw = x_cT_vee2_TE;
                % Chord
                c_y1_vee2_pw = x_2R_y1_vee2_pw - x_1R_y1_vee2_pw; % defines chord of wing at beginning of prop wash surface
                c_y2_vee2_pw = x_2R_y2_vee2_pw - x_1R_y2_vee2_pw; % defines chord of wing at beginning of prop wash surface
                % Storing DATA
                Geo_tier.x_1R_y1_vee2_pw = x_1R_y1_vee2_pw;
                Geo_tier.x_2R_y1_vee2_pw = x_2R_y1_vee2_pw;
                Geo_tier.x_1R_y2_vee2_pw = x_1R_y2_vee2_pw;
                Geo_tier.x_2R_y2_vee2_pw = x_2R_y2_vee2_pw;
                Geo_tier.c_y1_vee2_pw = c_y1_vee2_pw;
                Geo_tier.c_y2_vee2_pw = c_y2_vee2_pw;
                % y-location
                y_1R_y1_vee2_pw = y_y1_prop_dw;
                y_2R_y1_vee2_pw = y_y1_prop_dw;
                y_1R_y2_vee2_pw = y_cT_vee2_LE;
                y_2R_y2_vee2_pw = y_cT_vee2_TE;
                % Storing DATA
                Geo_tier.y_1R_y1_vee2_pw = y_1R_y1_vee2_pw;
                Geo_tier.y_2R_y1_vee2_pw = y_2R_y1_vee2_pw;
                Geo_tier.y_1R_y2_vee2_pw = y_1R_y2_vee2_pw;
                Geo_tier.y_2R_y2_vee2_pw = y_2R_y2_vee2_pw;
                
                % Geometry
                lambda_vee2_pw = c_y2_vee2_pw/c_y1_vee2_pw; % vee2 prop wash taper ratio
                b_vee2_pw = y_1R_y2_vee2_pw - y_1R_y1_vee2_pw; % same span
                S_vee2_pw = b_vee2_pw*((c_y1_vee2_pw + c_y2_vee2_pw)/2); % total area effective surface
                
                b_vee2_pw = D_prop; % same span
                S_vee2_pw = b_vee2_pw*((c_y1_vee2_pw + c_y2_vee2_pw)/2); % total area effective surface
                ...
                AR_vee2_pw = b_vee2_pw^2/S_vee2_pw; % Aspect Ratio
                % Storing DATA
                Geo_tier.lambda_vee2_pw = lambda_vee2_pw;
                Geo_tier.b_vee2_pw = b_vee2_pw;
                Geo_tier.S_vee2_pw = S_vee2_pw;
                Geo_tier.AR_vee2_pw = AR_vee2_pw;
