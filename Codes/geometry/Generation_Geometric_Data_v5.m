...
if Vee == 1
    ...
    % Storing DATA
    Geo_tier.x_loc_LE_vee = x_loc_LE_veew2;
    ...
    %     cB_k2_w2 = Geo_tier.cB_k2_w2;
    % end
    cT_veew2 = Geo_tier.cT_vee;
    
    % Wingspan - vee
    b_vee_s = (b_vee_e/cos(dihedral_vee_e));
    % effective wingspan in y direction
    b_vee_pv = b_vee_s*sin(dihedral_vee_e); % effective wingspan in vertical direction direction
    ...
    S_vee_fus = cR_vee*b_vee_fus; % w2 area within the fuselage
%     S_w2 = S_w2_e; % w2 Reference area % Cola en V with no fuselage interference
    S_vee = S_vee_e + S_vee_fus; % w2 Reference area
    S_vee_ph = S_vee_s*cos(dihedral_vee_e); % Proyected area of the w1 ino the horizontal plane
    S_vee_pv = S_vee_s*sin(dihedral_vee_e); % Proyected area of the w1 ino the vertical plane
    ...
    %% Calculation of Sweep angles
    % Quarter Chord
    Lambda_c4_vee = Get_Nth_Lambda(1/4,AR_vee_e,Lambda_LE_vee,lambda_vee2_e);
    % Half chord
    ...
    % Storing DATAy_loc_1R_yB1_vee_CAD
    ...
    lfus_b_HTP = l_fus/b_vee;
    Geo_tier.lfus_b_vee = lfus_b_HTP;
...
if Vee2 == 1
    ...
    % Storing DATA
    Geo_tier.x_loc_LE_vee2 = x_loc_LE_vee2w2;
    ...
    %     cB_k2_w2 = Geo_tier.cB_k2_w2;
    % end
    cT_vee2w2 = Geo_tier.cT_vee2;
    
    % Wingspan - vee2
    b_vee2_s = (b_vee2_e/cos(dihedral_vee2_e));
    % effective wingspan in y direction
    b_vee2_pv = b_vee2_s*sin(dihedral_vee2_e); % effective wingspan in vertical direction direction
    ...
    S_vee2_fus = cR_vee2*b_vee2_fus; % w2 area within the fuselage
%     S_w2 = S_w2_e; % w2 Reference area % Cola en V with no fuselage interference
    S_vee2 = S_vee2_e + S_vee2_fus; % w2 Reference area
    S_vee2_ph = S_vee2_s*cos(dihedral_vee2_e); % Proyected area of the w1 ino the horizontal plane
    S_vee2_pv = S_vee2_s*sin(dihedral_vee2_e); % Proyected area of the w1 ino the vertical plane
    ...
    % Storing DATAy_loc_1R_yB1_vee2_CAD
    ...
    lfus_b_HTP = l_fus/b_vee2;
    Geo_tier.lfus_b_vee2 = lfus_b_HTP;
...
if d_rudvtr2 == 1
    ...
    y_2R_y1_rudvtr2 = y_1R_y1_rudvtr; % inner position from the center line
    y_1R_y2_rudvtr2 = y_offset_vee2 + (b_vee2_e/2)*K_y2_rudvtr_vee2; % outter position from the center line
    y_2R_y2_rudvtr2 = y_1R_y2_rudvtr; % outter position from the center line
    
    % Calculates geometric information regarding the control surfaces
    CS_geo = Get_ControlSurface_Coordinates(y_1R_y1_rudvtr2,y_2R_y1_rudvtr2,y_1R_y2_rudvtr2,y_2R_y2_rudvtr2,...
        x_1R_y1_vee2,x_2R_y1_vee2,y_offset_vee2,Lambda_LE_vee2,Lambda_TE_vee2,Lambda_c4_vee2,dihedral_vee2,cf_rudvtr,AC_CONFIGURATION,VTP_cs);
