...
figure(1)
Du=u1*0.20; % change in speed ft/s
x0=[Du 0 0 0];
tf1=50;
tf2=0.1;
...
title(['Longitudinal Response for the airplane to a change in Speed of ',num2str(Du) 'ft/s'])
ylabel('\Deltau, ft/s')
grid on
...
figure(2)
Dalpha=10*pi/180; % change in speed ft/s
x0=[0 Dalpha 0 0];
tf1=50;
tf2=0.1;
...
[y_speed,t_speed,x_speed]=initial(sys_speed,x0,tf1);
plot(t_speed,y_speed)
title(['Longitudinal Response for the airplane to a \Deltau=',num2str(-Du),'ft/s and a \Delta\alpha=',num2str(Dalpha*180/pi),'\circ'])
ylabel('\Deltau, ft/s')
grid on
...
figure(4)
Dq=10*pi/180; % change in speed ft/s
x0=[0 0 Dq 0];
tf1=90;
tf2=0.1;
