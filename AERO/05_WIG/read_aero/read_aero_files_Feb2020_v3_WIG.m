...
casE = casE + 1;
casos{casE} = 'T1-125_0 m_s-VLM2-0_0kg-x0_4m-TG.txt'; 
X_OC(casE) = 0.401;
st{casE} = strcat('VLM - WIG  - OGE - XFLR5');
casE = casE + 1;
casos{casE} = 'T1-125_0 m_s-VLM2-0_0kg-x0_4m-TG5.txt'; 
X_OC(casE) = 0.401;
st{casE} = strcat('VLM - WIG  - IGE - 5 m - XFLR5');
