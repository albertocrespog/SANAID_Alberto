...
casos{10} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_041m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
casos{11} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_042m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
casos{12} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_043m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
casos{13} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_044m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
casos{14} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_045m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
casos{15} = 'EMERGENTIA_Sw1_e_dihedral_T1-25_0 m_s-LLT-proj_area_x0_046m.txt'; % Front Wing alone meassured @ -0.031 from Leading Edge
